...
- [Instalar Chef en Windows y crear máquinas virtuales de Azure](../articles/chef/chef-automation.md).
...
- [Instalar y configurar Terraform con Azure](/azure/developer/terraform/install-configure).
