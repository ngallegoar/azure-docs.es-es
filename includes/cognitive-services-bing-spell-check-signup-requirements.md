...
[Recurso de Bing Spell Check](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSpellCheck-v7)
   ...
   * API Bing Spell Check también se ofrece en algunos niveles del [recurso Bing Search, versión 7](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSearch-v7).
