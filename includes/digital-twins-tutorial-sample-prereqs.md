...
El tutorial utiliza un proyecto de ejemplo escrito en C#. El ejemplo se encuentra aquí: [Ejemplos de Azure Digital Twins de un extremo a otro](/samples/azure-samples/digital-twins-samples/digital-twins-samples). Para **obtener el proyecto de ejemplo** en la máquina, vaya al vínculo del ejemplo y seleccione el botón *Descargar ZIP* situado debajo del título.

Se descargará una carpeta *.ZIP* en la máquina llamada **Azure_Digital_Twins_end_to_end_samples.zip**. Descomprima la carpeta y extraiga los archivos.
