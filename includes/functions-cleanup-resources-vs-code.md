...
1. En la pestaña **Introducción**, seleccione el vínculo con nombre en **Grupo de recursos**.
    ...
    ![Seleccione el grupo de recursos que se va a eliminar de la página de la aplicación de función.](./media/functions-cleanup-resources-vs-code/functions-app-delete-resource-group.png)
