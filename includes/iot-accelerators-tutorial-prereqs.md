...
Si aún no ha implementado el acelerador de soluciones de supervisión remota, debe completar la guía de inicio rápido [Implementación de una solución de supervisión remota basada en la nube](../articles/iot-accelerators/quickstart-remote-monitoring-deploy.md).
