---
author: baanders
description: 'archivo de inclusión para comprobar el registro de aplicación en la configuración de Azure Digital Twins: 2'
...
ms.locfileid: "87405607"
---
:::image type="content" source="../articles/digital-twins/media/how-to-set-up-instance/portal/verify-manifest.png" alt-text="Vista del portal del manifiesto para el registro de aplicaciones de Azure AD":::
