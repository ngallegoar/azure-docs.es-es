...
* [Creación de un recurso de evaluación](https://azure.microsoft.com/try/cognitive-services/?api=bing-web-search-api):
...
* [Creación de un recurso de Bing Entity Search](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingEntitySearch):
    ...
    * Bing Entity Search también se ofrece en los niveles de pago del [recurso Bing Search, versión 7](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSearch-v7).
