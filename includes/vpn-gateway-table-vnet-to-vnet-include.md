...
ms.locfileid: "67186190"
---
| **Método o modelo de implementación** | **Azure Portal** | **PowerShell** | **CLI de Azure** |
| --- | --- | --- | --- |
| Clásico |[Tutorial*](../articles/vpn-gateway/vpn-gateway-howto-vnet-vnet-portal-classic.md)|Compatible | No compatible|
...
| Conexiones entre distintos modelos de implementación |[Tutorial*](../articles/vpn-gateway/vpn-gateway-connect-different-deployment-models-portal.md) |[Tutorial](../articles/vpn-gateway/vpn-gateway-connect-different-deployment-models-powershell.md) | No compatible |
