...
Como puede ver, cuando usa una SAS, no expone su clave de cuenta en la aplicación. Para obtener más información sobre SAS y los procedimientos de uso recomendados, consulte [Firmas de acceso compartido: Descripción del modelo SAS](../articles/storage/common/storage-sas-overview.md).