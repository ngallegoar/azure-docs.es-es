...
> [!NOTE]
> Para completar estos pasos, tiene que tener una cuenta de Azure. Si no tiene una cuenta de Azure, puede registrarse para obtener una [evaluación gratuita](../articles/active-directory/fundamentals/sign-up-organization.md).
