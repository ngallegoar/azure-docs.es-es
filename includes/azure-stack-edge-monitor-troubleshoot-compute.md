...
### <a name="use-dkrdbe-commands"></a>Usar comandos `dkrdbe`

Para ver una lista de comandos disponibles, [conéctese a la interfaz de PowerShell](#connect-to-the-powershell-interface) y utilice la función `dkrdbe`.
