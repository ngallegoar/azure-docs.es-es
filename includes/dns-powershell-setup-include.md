...
Abre la consola de PowerShell y conéctate a tu cuenta. Para más información, consulte [Inicio de sesión con AzureRM](/powershell/azure/azurerm/authenticate-azureps).
