...
1. En Azure Portal, vaya a la página **Grupo de recursos**. 
   ...
   ![Seleccione el grupo de recursos que se va a eliminar de la página de la aplicación de función.](./media/functions-quickstart-cleanup/functions-app-delete-resource-group.png)

   Para llegar a esa página desde el panel, seleccione **Grupos de recursos** y, después, seleccione el grupo que ha utilizado para esta guía de inicio rápido.
