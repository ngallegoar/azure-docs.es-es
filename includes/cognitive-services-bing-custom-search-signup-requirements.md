...
ms.locfileid: "74972714"
---
## <a name="create-an-azure-resource"></a>Creación de un recurso de Azure

Comience a usar Bing Custom Search API mediante la creación de uno de los recursos de Azure que se indican a continuación.

* [Creación de un recurso de evaluación](https://azure.microsoft.com/try/cognitive-services/?api=bing-custom-search-api):
...
* [Creación de un recurso de Bing Custom Search](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingCustomSearch):
