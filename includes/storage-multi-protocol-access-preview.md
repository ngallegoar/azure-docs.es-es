...
ms.locfileid: "85550965"
---
> [!NOTE]
> Las características que se describen en este artículo ya están disponibles para las cuentas que tienen un espacio de nombres jerárquico. Para revisar las limitaciones, consulte el artículo [Características de Blob Storage disponibles en Azure Data Lake Storage Gen2](https://docs.microsoft.com/azure/storage/blobs/data-lake-storage-supported-blob-storage-features).
