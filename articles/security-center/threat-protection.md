...
* **Protección contra amenazas para los recursos de datos de Azure**: SQL Database y Azure Synapse Analytics (antes SQL Data Warehouse), Azure Storage y Azure Cosmos DB
...
## <a name="threat-protection-for-sql-database-and-azure-synapse-analytics-formerly-sql-data-warehouse"></a>Protección contra amenazas para SQL Database y Azure Synapse Analytics (antes SQL Data Warehouse) <a name="data-sql"></a>
...
Advanced Threat Protection para Azure SQL Database y SQL forman parte del paquete unificado [Advanced Data Security (ADS)](https://docs.microsoft.com/azure/sql-database/sql-database-advanced-data-security) para funcionalidades SQL de seguridad avanzadas, que abarca Azure SQL Database, Azure SQL Managed Instances, bases de datos de Azure Synapse Analytics (antes SQL Data Warehouse) y servidores SQL Server en Azure Virtual Machines.
...
* [La lista de alertas de protección contra amenazas de SQL Database y Azure Synapse Analytics (antes SQL Data Warehouse)](alerts-reference.md#alerts-sql-db-and-warehouse)
