...
3. Compruebe las versiones más recientes del dispositivo y los valores hash:
    ...
    - Para la nube pública de Azure:
        ...
        **Algoritmo** | **Descargar** | **SHA256**
        --- | --- | ---
        VMware (11,9 GB) | [La versión más reciente](https://go.microsoft.com/fwlink/?linkid=2140333) | bd5c19eec93a62d52cc507a6b7b408d07f33f92b7d39b8a1e3dfec4ec62830d7
...
- [Evalúe las máquinas virtuales de VMware](tutorial-assess-vmware.md) para la migración a máquinas virtuales de Azure.
