...
> * Servidores detectados mediante un archivo CSV importado. Ahora, ejecute una evaluación de la [migración de máquinas virtuales de VMware a máquinas virtuales de Azure](./tutorial-assess-vmware-azure-vm.md).