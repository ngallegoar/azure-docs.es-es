...
**Total disks read ops** (Total de operaciones de lectura de discos) | No | Operaciones de lectura por segundo de todos los discos combinados. <br/> Use este campo si no puede proporcionar datos en el nivel de disco. 
**Total disks write ops** (Total de operaciones de escritura de discos) | No | Operaciones de escritura por segundo de todos los discos combinados. <br/> Use este campo si no puede proporcionar datos en el nivel de disco.
**Total disks read throughput** (Total de rendimiento de lectura de discos) | No | Datos leídos de todos los discos, en MB por segundo. <br/> Use este campo si no puede proporcionar datos en el nivel de disco. 
**Total disks write throughput** (Total de rendimiento de escritura de discos) | No | Datos escritos en todos los discos, en MB por segundo. <br/> Use este campo si no puede proporcionar datos en el nivel de disco.
...
Si no puede proporcionar datos en el nivel de disco, puede proporcionar datos de rendimiento de disco por servidor con los siguientes campos. Consulte [esta](#add-server-information) sección para obtener más información sobre cada campo.
- Total disks read ops (Total de operaciones de lectura de discos)
- Total disks write ops (Total de operaciones de escritura de discos)
- Total disks read throughput (Total de rendimiento de lectura de discos)
- Total disks write throughput (Total de rendimiento de escritura de discos)
