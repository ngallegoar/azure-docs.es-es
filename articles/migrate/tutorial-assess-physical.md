...
1. En la página **Servidores** > **Servidores Windows y Linux**, haga clic en **Evaluar y migrar servidores**.
   ...
   ![Ubicación del botón Evaluar y migrar servidores](./media/tutorial-assess-physical/assess.png)

2. En **Azure Migrate: Server Assessment**, haga clic en **Evaluar**.

    ![Ubicación del botón Evaluar](./media/tutorial-assess-physical/assess-servers.png)
...
6. Haga clic en **View all** (Ver todo) para revisar la configuración de la valoración.
    ...
    ![Ubicación del botón Ver todo para revisar las propiedades de valoración](./media/tutorial-assess-physical/assessment-name.png)
...
10. Haga clic en **Guardar** si realiza cambios.
    ...
    ![Propiedades de la evaluación](./media/tutorial-assess-physical/assessment-properties.png)
