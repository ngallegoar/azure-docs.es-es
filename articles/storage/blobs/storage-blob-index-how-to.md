...
2. En el administrador de paquetes de NuGet, busque el paquete **Azure.Storage.Blobs** e instale la versión **12.5.0-dev.20200422.2** en el proyecto. También puede ejecutar el comando ```Install-Package Azure.Storage.Blobs -Version12.5.0-dev.20200422.2```.
