...
| Recomendación | Comentarios | Security Center |
|-|----|--|
| Configurar la versión mínima necesaria de Seguridad de la capa de transporte (TLS) para una cuenta de almacenamiento.  | Exija que los clientes usen una versión más segura de TLS para realizar solicitudes en una cuenta de Azure Storage, para lo que debe configurar la versión mínima de TLS para esa cuenta. Para más información, consulte [Configuración de la versión mínima necesaria de Seguridad de la capa de transporte (TLS) para una cuenta de almacenamiento](../common/transport-layer-security-configure-minimum-version.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json)| - |
