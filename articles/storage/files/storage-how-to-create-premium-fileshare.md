...
description: En este artículo, aprenderá a crear un recurso compartido de archivos de Azure Premium mediante Azure Portal, PowerShell o la CLI de Azure.
author: roygara
ms.service: storage
ms.topic: how-to
ms.date: 05/05/2019
