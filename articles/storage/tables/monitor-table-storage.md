...
Para obtener una lista de todas las métricas compatibles de Azure Monitor, lo que incluye Azure Table Storage, vea [Métricas compatibles con Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/platform/metrics-supported).
...
Puede mostrar la definición de la métrica de la cuenta de almacenamiento o el servicio Table Storage. Use el cmdlet [Get-AzMetricDefinition](https://docs.microsoft.com/powershell/module/az.monitor/get-azmetricdefinition).
...
Puede leer valores de métricas de nivel de cuenta de la cuenta de almacenamiento o el servicio Table Storage. Use el cmdlet [Get-AzMetric](https://docs.microsoft.com/powershell/module/Az.Monitor/Get-AzMetric).
...
Puede mostrar la definición de la métrica de la cuenta de almacenamiento o el servicio Table Storage. Use el comando [az monitor metrics list-definitions](https://docs.microsoft.com/cli/azure/monitor/metrics#az-monitor-metrics-list-definitions).
...
Puede leer los valores de métricas de la cuenta de almacenamiento o el servicio Table Storage. Use el comando [az monitor metrics list](https://docs.microsoft.com/cli/azure/monitor/metrics#az-monitor-metrics-list).
...
Estas son algunas consultas que puede escribir en la barra **Búsqueda de registros** para ayudarle a supervisar su instancia de Table Storage. Estas consultas funcionan con el [nuevo lenguaje](https://docs.microsoft.com/azure/azure-monitor/log-query/log-query-overview).
