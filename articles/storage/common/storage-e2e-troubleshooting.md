---
title: Solución de problemas de operaciones de datos con diagnósticos y el analizador de mensajes
...
#### <a name="status-code-404-not-found-examples"></a>Ejemplos de código de estado 404 (no encontrado)
...
#### <a name="status-code-409-conflict-examples"></a>Ejemplos de código de estado de 409 (conflicto)
...
#### <a name="status-code-412-precondition-failed-examples"></a>Ejemplos de código de estado 412 (error de condición previa)
...
| --- | --- | --- |
| Retrasos inesperados en la entrega de mensajes en una cola |AzureStorageClientDotNetV4.Description contiene "Intentando de nuevo la operación con error." |Remoto |
...
| Aumento en PercentTimeoutError (todos) |*StatusCode   == 500 |All |
| Aumento de PercentNetworkError |AzureStorageClientDotNetV4.EventLogEntry.Level   < 2 |Remoto |
