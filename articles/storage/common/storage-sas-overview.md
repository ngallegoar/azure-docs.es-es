...
- **Use registros de Azure Monitor y Azure Storage para supervisar la aplicación.** Puede hacer uso de registros de Azure Monitor y Storage Analytics para observar cualquier pico en los errores de autorización producidos por la interrupción del servicio del proveedor de SAS o la eliminación involuntaria de una directiva de acceso almacenada. Para obtener más información, consulte [Métricas de Azure Storage en Azure Monitor](../blobs/monitor-blob-storage.md?toc=%252fazure%252fstorage%252fblobs%252ftoc.json) y [Registro de Azure Storage Analytics](storage-analytics-logging.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json).
