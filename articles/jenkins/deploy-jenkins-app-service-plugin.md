...
## <a name="add-an-azure-service-principal-to-the-jenkins-credentials"></a><a name="service-principal"></a> Adición de una entidad de servicio de Azure a las credenciales de Jenkins
