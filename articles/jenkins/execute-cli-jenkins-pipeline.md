---
title: Ejecución de la CLI de Azure con Jenkins
...
Para realizar este tutorial es necesaria la versión 2.0.4 o superior de la CLI de Azure. Para encontrar la versión, ejecute `az --version`. Si debe actualizarla, consulte [Instalación de la CLI de Azure]( /cli/azure/install-azure-cli).
...
Establezca la configuración del sistema en tiempo de ejecución de Java que necesita la aplicación con el comando [az appservice web config update](/cli/azure/webapp/config).

El siguiente comando configura la aplicación web para que se ejecute en una versión reciente de Java 8 JDK y en [Apache Tomcat](https://tomcat.apache.org/) 8.0.
...
* Siga los pasos descritos [aquí](../app-service/containers/quickstart-nodejs.md) para crear una aplicación web de Azure que se ejecute en Linux.
