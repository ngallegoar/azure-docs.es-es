---
title: Un inicio rápido para cargar datos en un grupo de SQL mediante la actividad de copia
description: Uso de Azure Synapse Analytics para cargar datos en un grupo de SQL
...
ms.locfileid: "93280852"
---
# <a name="quickstart-load-data-into-sql-pool-using-copy-activity"></a>Inicio rápido: Carga de datos en un grupo de SQL mediante la actividad de copia
...
En este inicio rápido, aprenderá a *cargar datos de Azure SQL Database en Azure Synapse Analytics*. Puede seguir los mismos pasos para copiar datos de otros tipos de almacenes de datos. Y el flujo similar se aplica también a la copia de datos entre otros orígenes y receptores.
...
* Azure Synapse Analytics: Puede usar un grupo de SQL como almacén de datos receptor. Si no tiene una instancia de Azure Synapse Analytics, consulte [Creación de un grupo de SQL](quickstart-create-sql-pool-portal.md) para ver los pasos para crear una.
...
En Azure Synapse Analytics, un servicio vinculado es donde se define la información de conexión a otros servicios. En esta sección, creará los dos tipos de servicios vinculados siguientes: Servicios vinculados Azure SQL Database y Azure Data Lake Storage Gen2.
...
Una canalización contiene el flujo lógico para una ejecución de un conjunto de actividades. En esta sección, creará una canalización que contiene una actividad de copia que ingiere datos de Azure SQL Database en un grupo de SQL.
...
1. Seleccione **Grupo de SQL Analytics** como almacén de datos y, después, seleccione **Continuar**.
