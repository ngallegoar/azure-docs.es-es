...
Para obtener más información sobre la optimización de transacciones, vea [Procedimientos recomendados relacionados con las transacciones](../sql-data-warehouse/sql-data-warehouse-develop-best-practices-transactions.md?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json). También se proporcionan guías de procedimientos recomendados adicionales para el [grupo de SQL](best-practices-sql-pool.md) y [SQL a petición (versión preliminar)](on-demand-workspace-overview.md).
