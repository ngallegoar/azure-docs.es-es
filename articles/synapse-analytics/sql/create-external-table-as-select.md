...
description: En este artículo, aprenderá a almacenar los resultados de las consultas en Storage mediante el grupo de SQL sin servidor (versión preliminar).
...
ms.locfileid: "93322609"
---
# <a name="store-query-results-to-storage-using-serverless-sql-pool-preview-in-azure-synapse-analytics"></a>Almacenamiento de resultados de consultas en Storage mediante el grupo de SQL sin servidor (versión preliminar) en Azure Synapse Analytics

En este artículo, aprenderá a almacenar los resultados de las consultas en Storage mediante el grupo de SQL sin servidor (versión preliminar).
