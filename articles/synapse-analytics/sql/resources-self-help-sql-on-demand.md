...
1) La red impide la comunicación con el back-end de Azure Synapse. El caso más frecuente es que el puerto 1443 está bloqueado. Para que SQL a petición funcione, desbloquee este puerto. Otros problemas podrían impedir que SQL a petición funcione también, [visite la guía de solución de problemas completa para más información](../troubleshoot/troubleshoot-synapse-studio.md).
