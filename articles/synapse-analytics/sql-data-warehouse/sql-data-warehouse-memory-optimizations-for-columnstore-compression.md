...
Para ver una discusión en profundidad sobre los requisitos de memoria del almacén de columnas, eche un vistazo al vídeo [SQL Analytics scaling: configuration and guidance](https://channel9.msdn.com/Events/Ignite/2016/BRK3291) (Escalado de SQL Analytics: configuración y directrices).
...
Para descubrir más formas de mejorar el rendimiento en SQL Analytics, consulte el tema de [información general sobre rendimiento](cheat-sheet.md).
