...
En este ejemplo se usa [CREATE TABLE AS SELECT](https://docs.microsoft.com/sql/t-sql/statements/create-table-as-select-azure-sql-data-warehouse?view=aps-pdw-2016-au7) para volver a crear una tabla con una columna de distribución por hash diferente.
