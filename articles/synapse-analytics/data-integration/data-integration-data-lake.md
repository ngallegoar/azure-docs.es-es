...
Para obtener más información sobre la integración de datos para Synapse Analytics, consulte el artículo [Ingesta de datos en un grupo de SQL dedicado](data-integration-sql-pool.md).
