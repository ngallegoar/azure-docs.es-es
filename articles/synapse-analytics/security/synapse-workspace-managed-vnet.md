---
title: Red virtual administrada en Azure Synapse Analytics
...
## <a name="managed-workspace-vnet"></a>Red virtual de área de trabajo administrada

Al crear el área de trabajo de Azure Synapse, puede elegir asociarla a una red virtual. La red virtual asociada al área de trabajo se administra mediante Azure Synapse. Esta red virtual se conoce como *red virtual de área de trabajo administrada*.

La red virtual de área de trabajo administrada resulta valiosa de cuatro formas:
...
- La red virtual de área de trabajo administrada junto con los puntos de conexión privados administrados protege contra la filtración de datos. Solo puede crear puntos de conexión privados administrados en un área de trabajo que tenga asociada una red virtual de área de trabajo administrada.
...
Si el área de trabajo tiene una red virtual de área de trabajo administrada, en ella se implementan la integración de datos y los recursos de Spark. Una red virtual de área de trabajo administrada también proporciona aislamiento de nivel de usuario para las actividades de Spark, ya que cada clúster de Spark está en su propia subred.

El grupo de SQL y SQL a petición son funcionalidades de varios inquilinos y, por tanto, residen fuera de la red virtual de área de trabajo administrada. En la comunicación dentro del área de trabajo con el grupo de SQL y SQL a petición se usan vínculos privados de Azure. Estos vínculos privados se crean automáticamente cuando se crea un área de trabajo con una red virtual de área de trabajo administrada asociada.

>[!IMPORTANT]
>Esta configuración del área de trabajo no se puede cambiar una vez creada el área de trabajo. Por ejemplo, no puede volver a volver a configurar un área de trabajo que no tenga una red virtual de área de trabajo administrada asociada y asociarle una red virtual. Del mismo modo, no puede volver a configurar un área de trabajo con una red virtual de área de trabajo administrada asociada y eliminarle la asociación de la red virtual.
...
>[!IMPORTANT]
>Solo puede usar vínculos privados en un área de trabajo que tenga una red virtual de área de trabajo administrada.
