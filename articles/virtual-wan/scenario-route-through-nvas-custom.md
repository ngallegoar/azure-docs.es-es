...
:::image type="content" source="./media/routing-scenarios/nva-custom/figure-2.png" alt-text="Ilustración 1" lightbox="./media/routing-scenarios/nva-custom/figure-2.png":::
