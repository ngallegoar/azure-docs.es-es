---
title: Introducción al almacenamiento de colas mediante Visual Studio (proyectos de WebJob)
...
**Nota:** el panel puede no mostrar correctamente el estado y la salida de funciones que se hayan finalizado.
...
Para crear varios mensajes, convierta el tipo de parámetro de la cola de salida **ICollector\<T>** o **IAsyncCollector\<T>** , como se muestra en el siguiente ejemplo.
...
* **ICollector**
* **IAsyncCollector**
* **CloudQueue** (para crear manualmente mensajes usando directamente la API de Azure Storage)
