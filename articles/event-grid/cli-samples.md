...
| [Suscripción a suscripciones de Azure](scripts/event-grid-cli-azure-subscription.md)| Permite la suscripción a eventos de una suscripción de Azure. |
