...
* Consulte [Supervisión del estado del área de trabajo de Log Analytics en Azure Monitor](../platform/monitor-workspace.md) para crear reglas de alerta y así supervisar el estado del área de trabajo. 
* Para habilitar la recopilación de datos de los recursos de Azure con Azure Diagnostics o Azure Storage, consulte [Recopilación de registros y métricas de servicio de Azure para usarlos en Log Analytics](../platform/resource-logs.md#send-to-log-analytics-workspace).
