...
- [Referencia de la API del agente de Application Insights de Azure Monitor](./app/status-monitor-v2-api-reference.md): se ha consolidado la referencia de la API.
...
- [Opciones de configuración: agente independiente de Java para Application Insights de Azure Monitor](./app/java-standalone-config.md): nuevo artículo.
- [Supervisión de aplicaciones sin código de Java con Azure Monitor Application Insights: versión preliminar pública](./app/java-in-process-agent.md): nuevo artículo.
- [Configuración de los argumentos de JVM del agente independiente de Java para Application Insights de Azure Monitor](./app/java-standalone-arguments.md): nuevo artículo.
- [Supervisión sin código de aplicaciones de Java en el entorno local con Application Insights de Azure Monitor: versión preliminar pública](./app/java-on-premises.md): nuevo artículo.
...
- [Cómo detener la supervisión del clúster híbrido](./insights/container-insights-optout-hybrid.md): nuevo artículo.

### <a name="insights"></a>Información detallada

- [Introducción a Azure Monitor](./insights/key-vault-insights-overview.md): nuevo artículo.
...
- [Creación de alertas a partir de Azure Monitor para VM](./insights/vminsights-alerts.md): nuevo artículo.
