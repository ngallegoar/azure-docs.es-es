...
Vea [Introducción a Azure Monitor para contenedores](./container-insights-overview.md).
...
Vea [Supervisar los grupos de recursos con Azure Monitor (versión preliminar)](./resource-group-insights.md).
