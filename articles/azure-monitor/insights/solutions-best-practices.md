---
title: Procedimientos recomendados para soluciones de administración en Azure
description: En este artículo, obtendrá sugerencias para crear un archivo de solución de administración. Observe cómo trabajar con orígenes de datos, runbooks, vistas y alertas.
ms.subservice: ''
ms.topic: conceptual
author: bwren
ms.author: bwren
