...
> [!NOTE]
> En este artículo se describe la experiencia clásica del explorador de métricas que actualmente está en desuso y, finalmente, se retirará. Se recomienda comprobar la nueva experiencia, que se describe en [este artículo](../platform/metrics-charts.md).
...
![Arrastre por parte de un gráfico.](./media/metrics-explorer/12-drag.png)
...
![Mantener el mouse sobre un gráfico](./media/metrics-explorer/02-focus.png)
...
![El encabezado de una hoja.](./media/metrics-explorer/11-grain.png)

Puede ajustar la granularidad en la hoja Intervalo de tiempo:

![El encabezado de una hoja.](./media/metrics-explorer/grain.png)
...
![En el Explorador de métricas, elija Agregar gráfico](./media/metrics-explorer/04-add.png)

Seleccione **Editar** en un gráfico nuevo o uno existente para editar lo siguiente:

![Seleccionar una o más métricas](./media/metrics-explorer/08-select.png)
...
![Seleccionar Agrupación en, seleccione una propiedad en Agrupar por](./media/metrics-explorer/15-segment.png)
...
![Ajuste de la barra deslizante](./media/metrics-explorer/18-height.png)
...
![Edite el gráfico y, después, seleccione Agregación.](./media/metrics-explorer/05-aggregation.png)
...
![Cancelar la selección de todas las métricas para ver los valores predeterminados](./media/metrics-explorer/06-total.png)
...
![Haga clic en Configuración avanzada, seleccione Intervalo personalizado y especifique los valores máximo y mínimo](./media/metrics-explorer/y-axis-range.png)
...
![Hacer clic en Filtro, expanda una propiedad y comprobar algunos valores](./media/metrics-explorer/19-filter.png)
...
[Cree su propia propiedad](../../azure-monitor/app/api-custom-events-metrics.md#properties). Establézcala en un [inicializador de telemetría](../../azure-monitor/app/api-custom-events-metrics.md#defaults) para que aparezca en toda la telemetría, incluida la telemetría estándar enviada por distintos módulos SDK.

## <a name="edit-the-chart-type"></a>Edición del tipo de gráfico
Observe que puede cambiar entre cuadrículas y gráficos:

![Seleccionar una cuadrícula o gráfico y elegir un tipo de gráfico](./media/metrics-explorer/16-chart-grid.png)
...
![Elegir un favorito](./media/metrics-explorer/21-favorite-save.png)

Para ver de nuevo la hoja, **vaya a la hoja de información general** y abra Favoritos:

![En la hoja de información general, elegir Favoritos](./media/metrics-explorer/22-favorite-get.png)
...
![En los botones situados en la parte superior del Explorador de métricas](./media/metrics-explorer/17-reset.png)

## <a name="live-metrics-stream"></a>Live Metrics Stream

Para obtener una vista mucho más inmediata de la telemetría, abra [Live Stream](live-stream.md). La mayoría de las métricas tardan unos minutos en aparecer, como consecuencia del proceso de agregación. Por el contrario, las métricas activas están optimizadas para conseguir una latencia baja. 
...
![En el Explorador de métricas, elija Reglas de alertas, Agregar alerta](./media/metrics-explorer/appinsights-413setMetricAlert.png)

[Obtenga más información sobre alertas][alerts].


## <a name="continuous-export"></a>Exportación continua
Si quiere que los datos se exporten continuamente para procesarlos externamente, puede usar la [Exportación continua](../../azure-monitor/app/export-telemetry.md).

### <a name="power-bi"></a>Power BI
Si desea obtener vistas todavía más sofisticadas de los datos, puede [exportarlos a Power BI](https://blogs.msdn.com/b/powerbi/archive/2015/11/04/explore-your-application-insights-data-with-power-bi.aspx).

## <a name="analytics"></a>Análisis
[Análisis](../../azure-monitor/app/analytics.md) es una forma más versátil de analizar los datos de telemetría mediante un eficaz lenguaje de consulta. Utilícelo si desea combinar o calcular resultados a partir de métricas, o realizar una exploración en profundidad del rendimiento reciente de su aplicación. 
