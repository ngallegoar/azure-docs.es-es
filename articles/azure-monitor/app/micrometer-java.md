...
>
> Tanto WebFlux como Micrometer se admiten en el [agente de Java 3.0 para Application Insights](https://docs.microsoft.com/azure/azure-monitor/app/java-on-premises), que no requiere instrumentación. 
