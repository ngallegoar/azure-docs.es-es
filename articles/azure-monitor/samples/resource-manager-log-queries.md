...
* [Más información sobre las consultas de registro](../log-query/log-query-overview.md).
* [Más información sobre las funciones](../log-query/functions.md).