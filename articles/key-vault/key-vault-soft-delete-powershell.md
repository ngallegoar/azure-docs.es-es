...
- Enumerar todos los certificados eliminados de un almacén de claves: 
  ```powershell
...
- Purgar un certificado en estado eliminado: 
  ...
  > [!IMPORTANT]
  > Si purga un certificado se eliminará definitivamente y no se podrá volver a recuperar.
