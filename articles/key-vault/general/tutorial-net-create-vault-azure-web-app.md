...
> [!Important]
> Al igual que sucede con Key Vault, una aplicación web de Azure debe tener un nombre único. Reemplace \<your-webapp-name\> con el nombre de su aplicación web en los ejemplos siguientes.
