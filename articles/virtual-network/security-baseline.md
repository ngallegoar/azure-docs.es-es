...
### <a name="46-use-role-based-access-control-to-manage-access-to-resources"></a>4.6: Uso del control de acceso basado en roles para administrar el acceso a los recursos 
