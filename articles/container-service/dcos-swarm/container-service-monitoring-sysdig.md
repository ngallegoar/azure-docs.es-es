...
Acceda a la interfaz de usuario de DC/OS mediante `http://localhost:80/`. Una vez en la interfaz de usuario de DC/OS, vaya a "Universe" (Universo) en la parte inferior izquierda y busque "Sysdig".
