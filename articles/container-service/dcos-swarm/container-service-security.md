---
title: (EN DESUSO) Seguridad del contenedor en Azure Container Service
...
* **DC/OS**: [cómo asegurar su clúster](https://docs.mesosphere.com/1.12/administering-clusters/securing-your-cluster)
...
* Para más información sobre la seguridad de la plataforma de Azure, vaya al [Azure Security Center](https://www.microsoft.com/trustcenter/cloudservices/azure).
