---
title: '(EN DESUSO) Inicio rápido de Azure Container Service: Implementación del clúster de DC/OS'
...
Inicie sesión en la suscripción de Azure con el comando [az login](/cli/azure/reference-index#az-login) y siga las instrucciones de la pantalla.
...
Cree un clúster de DC/OS con el comando [az acs create](/cli/azure/acs#az-acs-create).
...
La interfaz de la línea de comandos de DC/OS se utiliza para administrar un clúster de DC/OS desde la línea de comandos. Instale la CLI de DC/OS con el comando [az acs dcos install-cli](/cli/azure/acs/dcos#az-acs-dcos-install-cli). Si usa Azure CloudShell, la CLI de DC/OS ya estará instalada. 
