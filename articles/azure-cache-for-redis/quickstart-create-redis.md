---
title: 'Inicio rápido: Creación de una instancia de Azure Redis Cache'
description: En este inicio rápido, aprenderá a crear una instancia de Azure Cache for Redis
author: yegu-ms
ms.author: yegu
ms.service: cache
ms.custom: mvc
...
ms.locfileid: "83228267"
---
# <a name="quickstart-create-an-azure-cache-for-redis-instance"></a>Inicio rápido: Creación de una instancia de Azure Redis Cache
