...
ms.locfileid: "85385913"
---
# <a name="azure-active-directory-b2c-partners"></a>Asociados de Azure Active Directory B2C

Nuestra red de asociados amplía las capacidades de la solución para ayudarle a crear experiencias directas para el usuario final. Con Azure AD B2C, puede integrarse con los asociados para habilitar los métodos de autenticación multifactor, habilitar la autenticación de cliente segura (SCA), realizar control de acceso basado en rol y combatir el fraude mediante la revisión de verificación de identidad. Use nuestros tutoriales detallados para aprender a integrar aplicaciones con los asociados que se enumeran a continuación.
...
## <a name="integration-partners"></a>Asociados de integración

| Asociado | Descripción y tutoriales de integración  |
| :--- | :--- |
