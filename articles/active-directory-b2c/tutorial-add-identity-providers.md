...
description: Siga este tutorial para aprender a agregar proveedores de identidades a las aplicaciones en Azure Active Directory B2C mediante Azure Portal.
