...
Para ver el ejemplo en funcionamiento, agregue las notificaciones que se muestran en el ejemplo siguiente a la sección ClaimsSchema del archivo de extensiones:
...
Agregue las siguientes transformaciones de notificaciones:
...
Agregue el siguiente perfil técnico:
...
En el elemento TrustFrameworkPolicy, agregue estos valores de SubJourneys tal y como se muestra en el ejemplo siguiente:
...
Agregue un recorrido del usuario que use las nuevas notificaciones, tal como se muestra en el ejemplo siguiente:
...
El siguiente es un ejemplo de un archivo de usuario de confianza que hace referencia a este UserJourney:
