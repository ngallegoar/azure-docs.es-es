---
title: Conexión con Microsoft Translator
description: Traducir texto y realizar otras tareas de lenguaje con las API REST de Microsoft Translator y Azure Logic Apps
services: logic-apps
...
Vea los desencadenadores y las acciones definidos en Swagger y vea también todos los límites en los [detalles del conector](/connectors/microsofttranslator/).
