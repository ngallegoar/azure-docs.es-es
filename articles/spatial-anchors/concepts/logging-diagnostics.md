...
- [LogLevel](/dotnet/api/microsoft.azure.spatialanchors.cloudspatialanchorsession.loglevel): especifica el nivel de detalle de los eventos que se van a recibir desde el entorno en tiempo de ejecución.
- [OnLogDebug](/dotnet/api/microsoft.azure.spatialanchors.cloudspatialanchorsession.onlogdebug): proporciona eventos de registro de depuración estándar.
- [Error](/dotnet/api/microsoft.azure.spatialanchors.cloudspatialanchorsession.error): proporciona eventos de registro que el entorno en tiempo de ejecución considera como errores.
