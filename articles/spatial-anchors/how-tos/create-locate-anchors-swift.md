...
Obtenga más información sobre el método [getStatusWithCompletionHandler](/objectivec/api/spatial-anchors/asacloudspatialanchorsession#getsessionstatus).
...
Obtenga más información sobre el método [delete](/objectivec/api/spatial-anchors/asacloudspatialanchorsession#deleteanchor).
