...
Más información sobre la estructura [CloudSpatialAnchorSession](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession).
...
Más información sobre la estructura [SessionConfiguration](/cpp/api/spatial-anchors/ndk/sessionconfiguration).
...
Obtenga más información sobre el delegado [TokenRequiredDelegate](/cpp/api/spatial-anchors/ndk/tokenrequireddelegate).
...
Obtenga más información sobre el método [Start](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#start).
...
Obtenga más información sobre el método [ProcessFrame](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#processframe).
...
Obtenga más información sobre el delegado [SessionUpdatedDelegate](/cpp/api/spatial-anchors/ndk/sessionupdateddelegate).
...
Más información sobre la estructura [CloudSpatialAnchor](/cpp/api/spatial-anchors/ndk/cloudspatialanchor).
...
Obtenga más información sobre el método [GetSessionStatusAsync](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#getsessionstatusasync).
...
Obtenga más información sobre el método [AppProperties](/cpp/api/spatial-anchors/ndk/cloudspatialanchor#appproperties).
...
Obtenga más información sobre el método [UpdateAnchorPropertiesAsync](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#updateanchorpropertiesasync).
...
Obtenga más información sobre el método [GetAnchorPropertiesAsync](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#getanchorpropertiesasync).
...
Obtenga más información sobre el método [Expiration](/cpp/api/spatial-anchors/ndk/cloudspatialanchor#expiration).
...
Obtenga más información sobre el método [CreateWatcher](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#createwatcher).
...
Más información sobre el método [AnchorLocated](/cpp/api/spatial-anchors/ndk/anchorlocateddelegate).
...
Obtenga más información sobre el método [DeleteAnchorAsync](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#deleteanchorasync).
...
Obtenga más información sobre el método [Stop](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#stop).
...
Más información sobre el método [Reset](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#reset).
