...
1. Cree un certificado raíz y, luego, derive un certificado de dispositivo ejecutando el script. Asegúrese de usar solo caracteres alfanuméricos en minúsculas y guiones para el nombre del certificado:
