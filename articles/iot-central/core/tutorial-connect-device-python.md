...
ms.locfileid: "80891601"
---
# <a name="tutorial-create-and-connect-a-python-client-application-to-your-azure-iot-central-application-python"></a>Tutorial: Creación y conexión de un aplicación cliente Python genérica a una aplicación de Azure IoT Central (Python)
