...
Antes de empezar, debe completar el tutorial anterior [Creación de una aplicación de análisis de vídeo en Azure IoT Central](./tutorial-video-analytics-create-app.md).
