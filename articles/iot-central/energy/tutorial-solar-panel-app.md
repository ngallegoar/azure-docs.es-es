...
> [Azure IoT Central: arquitectura de aplicaciones de panel solar](https://docs.microsoft.com/azure/iot-central/energy/concept-iot-central-solar-panel-app).
