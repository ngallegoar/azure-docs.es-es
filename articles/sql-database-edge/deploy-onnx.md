---
title: Implementación y creación de predicciones con ONNX en la versión preliminar de SQL Database Edge
description: Obtenga información sobre cómo entrenar un modelo, convertirlo a ONNX, implementarlo en la versión preliminar de Azure SQL Database Edge y, después, ejecutar la predicción nativa en los datos con el modelo de ONNX cargado.
...
* Si no ha implementado un módulo de Azure SQL Database Edge, siga los pasos de [implementación de la versión preliminar de SQL Database Edge mediante Azure Portal](deploy-portal.md).
...
Almacene el modelo en Azure SQL Database Edge, en una tabla de `models` en una base de datos de `onnx`. En la cadena de conexión, especifique la **dirección del servidor**, el **nombre de usuario** y la **contraseña**.
...
Cargue los datos en Azure SQL Database Edge.
...
Con el modelo en Azure SQL Database Edge, ejecute la predicción nativa en los datos mediante el modelo de ONNX cargado.
