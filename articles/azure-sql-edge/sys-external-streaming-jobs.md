---
title: 'sys.external_streaming_jobs (Transact-SQL): Azure SQL Edge (versión preliminar)'
description: Información sobre el uso de sys.external_streaming_jobs en Azure SQL Edge (versión preliminar)
