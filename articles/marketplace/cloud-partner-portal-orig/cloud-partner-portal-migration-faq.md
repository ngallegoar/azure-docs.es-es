---
title: Preguntas más frecuentes sobre la migración al Centro de partners | Azure Marketplace
description: En este artículo se abordan las preguntas más frecuentes sobre la migración de ofertas de Cloud Partner Portal al Centro de partners.
author: anbene
...
ms.locfileid: "81275821"
---
# <a name="frequently-asked-questions-for-migrating-from-the-cloud-partner-portal-to-partner-center"></a>Preguntas más frecuentes sobre la migración de Cloud Partner Portal al Centro de partners
...
Las ofertas se migrarán al Centro de partners a partir del 13 de abril hasta el mes de mayo. Durante este período de tiempo, podrá acceder al Cloud Partner Portal como de costumbre, excepto durante el tiempo en que esté programada la migración de su oferta.
Mientras se están migrando las ofertas, estas tendrán un estado bloqueado y un mensaje indicará que se están trasladando al Centro de partners, como se ve en la pantalla siguiente. Este período de migración debe ser inferior a 24 horas. Durante este tiempo, no podrá realizar ninguna actualización en sus ofertas. Recibirá una notificación por correo electrónico después de haber completado la migración de las ofertas.

:::image type="content" source="media/migration-faq/all-offers-1.png" alt-text="Muestra el estado de las ofertas migradas.":::

Después de migrar las ofertas, estarán en modo de solo lectura **durante un período de tiempo limitado** en Cloud Partner Portal. Su estado reflejará el traslado al Centro de partners e incluirá un vínculo a la oferta en el Centro de partners, como se muestra en las capturas de pantalla siguientes. Desde este momento, administrará las actualizaciones de todas las ofertas o creará nuevas ofertas exclusivamente a través del Centro de partners.
