...
Seleccione un mínimo de una y un máximo de tres categorías. Se usará la **categoría** para colocar la oferta en las áreas de búsqueda adecuadas de Marketplace. Asegúrese de indicar la forma en que la oferta da soporte a estas categorías en la descripción de la oferta.
...
Puede proporcionar el logotipo de la oferta en tres tamaños: **Pequeño (48 x 48)** , **Grande (216 x 216)** y **Ancho (255 x 115)** . Los tamaños Pequeño y Grande son obligatorios.
...
Es necesario cargar un archivo .pdf que enumere los escenarios de uso claves de la oferta enumerados en un documento (formato .pdf). Nuestro equipo de validación puede comprobar todos los escenarios que se enumeran aquí antes de aprobar su oferta para Marketplace.
