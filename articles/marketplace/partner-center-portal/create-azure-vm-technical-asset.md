...
Para conectarse a una máquina virtual basada en Linux, necesita un cliente de protocolo Secure Shell (SSH). En los pasos siguientes se usa el terminal gratuito de SSH [PuTTY](https://www.ssh.com/ssh/putty/).
