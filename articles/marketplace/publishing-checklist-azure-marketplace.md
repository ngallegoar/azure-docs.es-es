...
Los siguientes artefactos son necesarios para completar el flujo de trabajo de publicación para crear una oferta en Cloud Partner Portal.  

## <a name="checklist"></a>Lista de comprobación  

| Tipo de aplicación | Tipo de oferta | Artefacto de publicación |   
|:--- |:--- |:--- |  
