...
- Obtenga información sobre [Azure Data Box Edge](../databox-online/azure-stack-edge-overview.md) y [Azure Data Box Gateway](../databox-online/data-box-gateway-overview.md).
