...
> [!TIP]
> Puede crear o actualizar la suscripción del usuario para un *producto* con claves de suscripción personalizadas [mediante la API REST](https://docs.microsoft.com/rest/api/apimanagement/2019-12-01/subscription/createorupdate) o un comando de PowerShell.
