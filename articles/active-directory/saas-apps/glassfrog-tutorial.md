...
En esta sección, creará un usuario llamado Britta Simon en GlassFrog. Trabaje con el  [equipo de soporte técnico de GlassFrog](mailto:support@glassfrog.com) para agregar usuarios a la plataforma de GlassFrog. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.
