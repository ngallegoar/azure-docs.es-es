...
En esta sección, va a crear un usuario llamado B.Simon en Fastly Edge Cloud. Trabaje con el  [equipo de soporte técnico de Fastly Edge Cloud](mailto:support@fastly.com) para agregar los usuarios en la plataforma de Fastly Edge Cloud. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.
