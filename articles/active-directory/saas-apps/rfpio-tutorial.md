...
4. En la sección **Configuración básica de SAML** , si desea configurar la aplicación en modo iniciado por **IDP** , realice el siguiente paso:
    ...
    ![Captura de pantalla que muestra la configuración básica de SAML, donde puede escribir un identificador.](common/idp-identifier.png)
    ...
    ![Captura de pantalla que muestra la opción para establecer direcciones U R L adicionales.](common/idp-preintegrated-relay.png)
...
1. Haga clic en la lista desplegable de la esquina inferior izquierda.
    ...
    ![Captura de pantalla muestra la flecha hacia abajo en la parte inferior del panel.](./media/rfpio-tutorial/app1.png)

1. Haga clic en **Organization Settings** (Configuración de la organización). 

    ![Captura de pantalla que muestra la opción de configuración de la organización seleccionada.](./media/rfpio-tutorial/app2.png)

1. Haga clic en **FEATURES & INTEGRATION** (CARACTERÍSTICAS E INTEGRACIÓN).

    ![Captura de pantalla que muestra la opción de características e integración seleccionada en la configuración.](./media/rfpio-tutorial/app4.png)

1. En **SAML SSO Configuration** (Configuración del inicio de sesión único de SAML), haga clic en **Edit** (Editar).

    ![Captura de pantalla que muestra la configuración del inicio de sesión único de SAML con el botón de edición activado.](./media/rfpio-tutorial/app3.png)

1. En esta sección, realice las siguientes acciones:

    ![Captura de pantalla que muestra la configuración del inicio de sesión único de SAML con la opción de SAML habilitada.](./media/rfpio-tutorial/app5.png)
...
1. Haga clic en **TEAM MEMBERS** (MIEMBROS DE EQUIPO).
    ...
    ![Captura de pantalla que muestra la opción de miembros de equipo seleccionada en la configuración.](./media/rfpio-tutorial/app6.png)

1. Haga clic en **ADD MEMBERS** (AGREGAR MIEMBROS).

    ![Captura de pantalla que muestra el botón para agregar miembros.](./media/rfpio-tutorial/app7.png)

1. Vaya a la sección **Add New Members** (Agregar nuevos miembros). Realice las siguientes acciones:

    ![Captura de pantalla que muestra la sección para agregar nuevos miembros, donde puede especificar los valores descritos.](./media/rfpio-tutorial/app8.png)
...
Al hacer clic en el icono de RFPIO en el panel de acceso, debería iniciar sesión automáticamente en la versión de RFPIO para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
