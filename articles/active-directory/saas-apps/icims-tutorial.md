...
## <a name="configure-and-test-azure-ad-single-sign-on-for-icims"></a>Configuración y prueba del inicio de sesión único de Azure AD para ICIMS
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **ICIMS** , busque la sección **Administrar** y seleccione **Inicio de sesión único** .
...
1. En la sección **Configuración básica de SAML** , siga estos pasos:
    ...
    b. En el cuadro de texto **Identificador** , escriba una dirección URL: `icims.com`

    c. En el cuadro de texto **URL de respuesta** , escriba una dirección URL: `https://.icims.com/`
...
Al hacer clic en el icono de ICIMS en el panel de acceso, debería iniciar sesión automáticamente en la instancia de ICIMS para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Pruebe ICIMS con Azure AD](https://aad.portal.azure.com/)
