...
* Una vez configurado Profit.co SAML App, puede aplicar el control de sesión, que protege la filtración y la infiltración de la información confidencial de la organización en tiempo real. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Cloud App Security](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app).

## <a name="adding-profitco-saml-app-from-the-gallery"></a>Incorporación de Profit.co SAML App desde la galería
...
Configure y pruebe el inicio de sesión único de Azure AD con Profit.co SAML App mediante un usuario de prueba llamado **B.Simon**. Para que el inicio de sesión único funcione, es necesario establecer una relación de vinculación entre un usuario de Azure AD y el usuario relacionado de Profit.co SAML App.

Para configurar y probar el inicio de sesión único de Azure AD con Profit.co SAML App, complete los siguientes bloques de creación:
...
1. **[Configuración del inicio de sesión único en Profit.co SAML App](#configure-profitco-saml-app-sso)** : para configurar los valores de inicio de sesión único en la aplicación.
    1. **[Creación de un usuario de prueba de Profit.co SAML App](#create-profitco-saml-app-test-user)** : para tener un homólogo de B.Simon en Profit.co SAML App que esté vinculado a su representación en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Profit.co SAML App**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
### <a name="create-profitco-saml-app-test-user"></a>Creación de un usuario de prueba de Profit.co SAML App

En esta sección, creará un usuario llamado Britta Simon en Profit.co SAML App. Colabore con el [equipo de soporte técnico de Profit.co SAML App](mailto:support@profit.co) para agregar usuarios en la plataforma de Profit.co SAML App. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.

## <a name="test-sso"></a>Prueba de SSO 

En esta sección, probará la configuración de inicio de sesión único de Azure AD mediante el Panel de acceso.

Al hacer clic en el icono de Profit.co SAML App en el Panel de acceso, debería iniciar sesión automáticamente en la instancia de Profit.co SAML App para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
