...
1. En la página de integración de la aplicación [Zscaler Private Access Administrator](https://portal.azure.com/) de **Azure Portal**, seleccione **Inicio de sesión único**.
