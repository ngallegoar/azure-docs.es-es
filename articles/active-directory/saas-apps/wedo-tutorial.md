...
* [Una vez configurado WEDO, puede aplicar controles de sesión, que protegen la filtración e infiltración de la información confidencial de la organización en tiempo real. Los controles de sesión proceden del acceso condicional. Aprenda a aplicar el control de sesión con Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).
...
Al hacer clic en el icono de WEDO en el Panel de acceso, debería iniciar sesión automáticamente en la versión de WEDO para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Protección de WEDO con controles y visibilidad avanzados](/cloud-app-security/proxy-intro-aad)