...
En este tutorial, va a configurar y probar el inicio de sesión único de Azure AD en un entorno de prueba. OutSystems Azure AD admite el SSO iniciado por **SP e IDP**, así como el aprovisionamiento de usuarios **Just In Time**.

## <a name="adding-outsystems-azure-ad-from-the-gallery"></a>Adición de OutSystems Azure AD desde la galería
...
Configure y pruebe el inicio de sesión único de Azure AD con OutSystems Azure AD utilizando un usuario de prueba llamado **B. Simon**. Para que el SSO funcione, es necesario establecer una relación de vinculación entre un usuario de Azure AD y el usuario relacionado de OutSystems Azure AD.

Para configurar y probar el inicio de sesión único de Azure AD con OutSystems Azure AD, es preciso completar los siguientes bloques de creación:

1. **[Configuración del inicio de sesión único de Azure AD](#configure-azure-ad-sso)** , para permitir que los usuarios puedan utilizar esta característica.
2. **[Configuración de OutSystems Azure AD](#configure-outsystems-azure-ad)** , para configurar los valores del inicio de sesión único en la aplicación.
...
5. **[Creación de un usuario de prueba en OutSystems Azure AD](#create-outsystems-azure-ad-test-user)** para tener un homólogo de B. Simon en OutSystems Azure AD que esté vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **OutSystems Azure AD**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
### <a name="configure-outsystems-azure-ad"></a>Configuración de OutSystems Azure AD
...
En esta sección, va a permitir que B. Simon acceda a OutSystems Azure AD utilizando el inicio de sesión único de Azure.
...
Al seleccionar icono de OutSystems Azure AD en el Panel de acceso, debería iniciar sesión automáticamente en la versión de OutSystems Azure AD para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
