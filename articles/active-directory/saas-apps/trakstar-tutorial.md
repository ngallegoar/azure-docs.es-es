...
4. En el cuadro de búsqueda, escriba **Trakstar** , seleccione **Trakstar** en el panel de resultados y haga clic en el botón **Agregar** para agregar la aplicación.

     ![Trakstar en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Trakstar.
...
Para configurar el inicio de sesión único de Azure AD con Trakstar, siga estos pasos:

1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Trakstar** , seleccione **Inicio de sesión único** .
...
### <a name="configure-trakstar-single-sign-on"></a>Configuración del inicio de sesión único en Trakstar
...
1. En Azure Portal, seleccione **Aplicaciones empresariales** , **Todas las aplicaciones** , **Trakstar** .
...
Al hacer clic en el icono de Trakstar en el panel de acceso, debería iniciar sesión automáticamente en la versión de Trakstar para la que configurara el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
