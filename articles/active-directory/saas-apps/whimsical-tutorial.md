...
Para configurar y probar el inicio de sesión único de Azure AD con Whimsical, es preciso completar los siguientes bloques de creación:
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Whimsical** , busque la sección **Administrar** y seleccione **Inicio de sesión único** .
...
Al hacer clic en el icono de Whimsical en el Panel de acceso, debería iniciar sesión automáticamente en la instancia de Whimsical para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
