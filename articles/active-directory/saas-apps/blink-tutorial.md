...
* Blink admite el inicio de sesión único iniciado por el **proveedor de servicios** .
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-blink"></a>Configuración y prueba del inicio de sesión único de Azure AD para Blink
...
Para configurar y probar el inicio de sesión único de Azure AD con Blink, es preciso completar los siguientes bloques de creación:
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **Blink** , busque la sección **Administrar** y seleccione **Inicio de sesión único** .
...
Al hacer clic en el icono de Blink en el Panel de acceso, debería iniciar sesión automáticamente en la versión de Blink para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
