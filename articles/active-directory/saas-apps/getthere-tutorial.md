...
## <a name="configure-and-test-azure-ad-single-sign-on-for-getthere"></a>Configuración y prueba del inicio de sesión único de Azure AD para GetThere
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **GetThere** , busque la sección **Administrar** y seleccione **Inicio de sesión único** .
...
- [Pruebe GetThere con Azure AD](https://aad.portal.azure.com/)