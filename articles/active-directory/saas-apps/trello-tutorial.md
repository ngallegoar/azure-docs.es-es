...
## <a name="configure-and-test-azure-ad-single-sign-on-for-trello"></a>Configuración y prueba del inicio de sesión único de Azure AD para Trello
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **Trello** , busque la sección **Administrar** y seleccione **Inicio de sesión único** .
...
1. En la sección **Configuración básica de SAML** , si desea configurar la aplicación en modo iniciado por **IDP** , escriba los valores de los siguientes campos:
    ...
    a. En el cuadro de texto **Identificador** , escriba una dirección URL: `https://trello.com/auth/saml/metadata`
...
Al hacer clic en el icono de Trello en el panel de acceso, debería iniciar sesión automáticamente en la versión de Trello para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Pruebe Trello con Azure AD](https://aad.portal.azure.com/)