...
* Una vez configurado Box, puede aplicar el control de sesión, que protege la filtración y la infiltración de la información confidencial de la organización en tiempo real. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-aad).
...
Al hacer clic en el icono de Box en el panel de acceso y debería iniciar sesión automáticamente en la versión de Box para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Protección de Box con controles y visibilidad avanzados](/cloud-app-security/protect-box)