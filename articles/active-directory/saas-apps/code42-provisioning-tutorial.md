...
> * [Inicio de sesión único](https://docs.microsoft.com/azure/active-directory/saas-apps/code42-tutorial) en Code42 (recomendado)
...
3. Determine qué datos quiere [asignar entre Azure AD y Code42](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes).
