...
En esta sección, creará un usuario llamado Britta Simon en CS Stars. Trabaje con el  [equipo de soporte técnico de CS Stars](https://riskonnect.com/support/) para agregar los usuarios a la plataforma CS Stars. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.
