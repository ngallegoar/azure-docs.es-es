...
1. En la página de integración de la aplicación [Soonr Workplace](https://portal.azure.com/) de **Azure Portal**, seleccione **Inicio de sesión único**.
