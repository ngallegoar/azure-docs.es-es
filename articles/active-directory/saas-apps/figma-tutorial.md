...
## <a name="configure-and-test-azure-ad-single-sign-on-for-figma"></a>Configuración y prueba del inicio de sesión único de Azure AD para Figma
...
1. **[Configuración del inicio de sesión único en Figma](#configure-figma-sso)** , para configurar los valores de Inicio de sesión único en la aplicación.
    * **[Creación del usuario de prueba de Figma](#create-figma-test-user)** , para tener un homólogo de B.Simon en Figma vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **Figma** , busque la sección **Administrar** y seleccione **Inicio de sesión único** .
...
Al hacer clic en el icono de Figma en el panel de acceso, debería iniciar sesión automáticamente en la versión de Figma para la que configurara el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Pruebe Figma con Azure AD](https://aad.portal.azure.com/)