...
## <a name="configure-and-test-azure-ad-single-sign-on-for-blackboard-learn"></a>Configuración y prueba del inicio de sesión único de Azure AD para Blackboard Learn
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **Blackboard Learn**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
- [Probar Blackboard Learn con Azure AD](https://aad.portal.azure.com/)