...
En esta sección, creará un usuario llamado Britta Simon en itslearning. Colabore con el [equipo de soporte técnico de itslearning](mailto:support@itslearning.com) para agregar los usuarios a la plataforma de itslearning. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.
