...
3. Determine qué datos se [asignarán entre Azure AD y Apple School Manager](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes).
