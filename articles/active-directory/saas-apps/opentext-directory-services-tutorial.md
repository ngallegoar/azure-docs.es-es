...
- [Procedimiento para proteger OpenText Directory Services con visibilidad y controles avanzados](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
