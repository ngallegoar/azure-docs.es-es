...
## <a name="adding-assetsonar-from-the-gallery"></a>Adición de AssetSonar desde la galería
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-assetsonar"></a>Configuración y prueba del inicio de sesión único de Azure AD para AssetSonar
...
Para configurar y probar el inicio de sesión único de Azure AD con AssetSonar, es preciso completar los siguientes bloques de creación:
...
1. **[Configuración del inicio de sesión único en AssetSonar](#configure-assetsonar-sso)** , para configurar los valores de inicio de sesión único en la aplicación.
    * **[Creación de un usuario de prueba de AssetSonar](#create-assetsonar-test-user)** , para tener un homólogo de B.Simon en AssetSonar que esté vinculado a la representación de este usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **AssetSonar** , busque la sección **Administrar** y seleccione **Inicio de sesión único** .
...
Al hacer clic en el icono de AssetSonar en el panel de acceso, iniciará sesión automáticamente en la versión de AssetSonar para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Prueba de AssetSonar con Azure AD](https://aad.portal.azure.com/)