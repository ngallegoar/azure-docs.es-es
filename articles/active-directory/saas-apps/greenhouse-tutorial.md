...
* Puede habilitar a los usuarios para que inicien sesión automáticamente en Greenhouse (inicio de sesión único) con sus cuentas de Azure AD.
...
4. En el cuadro de búsqueda, escriba **Greenhouse** , seleccione **Greenhouse** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
     ...
     ![Greenhouse en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Greenhouse.
...
2. **[Configuración del inicio de sesión único de Greenhouse](#configure-greenhouse-single-sign-on)** : para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de Greenhouse](#create-greenhouse-test-user)** : para tener un homólogo de Britta Simon en Greenhouse que esté vinculado a su representación en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **Greenhouse** , seleccione **Inicio de sesión único** .
...
4. En la sección **Configuración básica de SAML** , siga estos pasos:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Greenhouse](common/sp-identifier.png)
...
### <a name="configure-greenhouse-single-sign-on"></a>Configuración del inicio de sesión único de Greenhouse

Para configurar el inicio de sesión único en **Greenhouse** , es preciso enviar el **XML de metadatos de federación** descargado y las direcciones URL apropiadas copiadas de Azure Portal al [ equipo de soporte técnico de Greenhouse](https://www.greenhouse.io/contact). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En Azure Portal, seleccione **Aplicaciones empresariales** , **Todas las aplicaciones** , **Greenhouse** .

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Greenhouse** .

    ![Enlace a Greenhouse en la lista de aplicaciones](common/all-applications.png)
...
2. En el menú en la parte superior, haga clic en **Configurar** y luego haga clic en **Usuarios** .
    ...
    ![Usuarios](./media/greenhouse-tutorial/ic790791.png "Usuarios")

3. Haga clic en **Nuevos usuarios** .
   
    ![New User](./media/greenhouse-tutorial/ic790792.png "Nuevo usuario") (Usuario nuevo)

4. En la sección **Agregar nuevo usuario** , lleve a cabo estos pasos:
   
    ![Add New User (Agregar nuevo usuario)](./media/greenhouse-tutorial/ic790793.png "Agregar nuevo usuario")
...
Al hacer clic en el icono de Greenhouse en el panel de acceso, debería iniciar sesión automáticamente en la instancia de Greenhouse para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
