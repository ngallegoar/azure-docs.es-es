...
## <a name="adding-terraform-enterprise-from-the-gallery"></a>Incorporación de Terraform Enterprise desde la galería
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-terraform-enterprise"></a>Configuración y prueba del inicio de sesión único de Azure AD para Terraform Enterprise
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **Terraform Enterprise** , busque la sección **Administrar** y seleccione **Inicio de sesión único** .
...
Al hacer clic en el icono de Terraform Enterprise del Panel de acceso, debería iniciar sesión automáticamente en la versión de Terraform Enterprise para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Pruebe Terraform Enterprise con Azure AD](https://aad.portal.azure.com/)