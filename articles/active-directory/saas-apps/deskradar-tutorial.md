...
## <a name="configure-and-test-azure-ad-single-sign-on-for-deskradar"></a>Configuración y prueba del inicio de sesión único de Azure AD para Deskradar
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **Deskradar** , busque la sección **Administrar** y seleccione **Inicio de sesión único** .
...
Al hacer clic en el icono de Deskradar en el panel de acceso y debería iniciar sesión automáticamente en la versión de Deskradar para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Pruebe Deskradar con Azure AD](https://aad.portal.azure.com/)