...
En esta sección, creará un usuario llamado Britta Simon en Bridge. Colabore con el  [equipo de soporte técnico de Bridge](https://community.bridgeapp.com/community/help) para agregar los usuarios a la plataforma de Bridge. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.
