...
* Una suscripción que permita el inicio de sesión único en FileCloud
...
4. En el cuadro de búsqueda, escriba **FileCloud** , seleccione **FileCloud** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
     ...
     ![FileCloud en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de FileCloud.
...
2. **[Configuración del inicio de sesión único de FileCloud](#configure-filecloud-single-sign-on)** : para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de FileCloud](#create-filecloud-test-user)** : para tener un homólogo de Britta Simon en FileCloud que esté vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **FileCloud** , seleccione **Inicio de sesión único** .
...
4. En la sección **Configuración básica de SAML** , siga estos pasos:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de FileCloud](common/sp-identifier.png)
...
### <a name="configure-filecloud-single-sign-on"></a>Configuración del inicio de sesión único de FileCloud
...
6. Abra el archivo de metadatos descargado en el Bloc de notas, copie el contenido del mismo en el Portapapeles y luego péguelo en el cuadro de texto **IdP Meta Data** (Metadatos de IdP) en el panel **Configuración de SAML** .
    ...
    ![Configuración del inicio de sesión único en la aplicación](./media/filecloud-tutorial/tutorial_filecloud_004.png)
...
1. En Azure Portal, seleccione **Aplicaciones empresariales** , **Todas las aplicaciones** , **FileCloud** .

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **FileCloud** .

    ![Enlace a FileCloud en la lista de aplicaciones](common/all-applications.png)
...
Al hacer clic en el icono de FileCloud en el panel de acceso, debería iniciar sesión automáticamente en la versión de FileCloud para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
