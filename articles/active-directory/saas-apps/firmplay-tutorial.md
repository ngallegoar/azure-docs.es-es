...
1. En la página de integración de aplicaciones [FirmPlay - Employee Advocacy for Recruiting](https://portal.azure.com/) de **Azure Portal**, seleccione **Inicio de sesión único**.
