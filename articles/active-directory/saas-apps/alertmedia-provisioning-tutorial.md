...
> * [Inicio de sesión único](https://docs.microsoft.com/azure/active-directory/saas-apps/alertmedia-tutorial) en AlertMedia (recomendado)
...
3. Determine qué datos quiere [asignar entre Azure AD y AlertMedia](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
