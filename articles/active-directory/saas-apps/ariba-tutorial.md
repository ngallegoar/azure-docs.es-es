...
4. En el cuadro de búsqueda, escriba **Ariba**, seleccione **Ariba** en el panel de resultados y haga clic en el botón **Agregar** para agregar la aplicación.

     ![Ariba en la lista de resultados](common/search-new-app.png)
...
2. **[Configuración del inicio de sesión único de Ariba](#configure-ariba-single-sign-on)** : para configurar los valores de Inicio de sesión único en la aplicación.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Ariba**, seleccione **Inicio de sesión único**.
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**,  **Ariba**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, escriba y seleccione **Ariba**.

    ![Vínculo a Ariba en la lista de aplicaciones](common/all-applications.png)
