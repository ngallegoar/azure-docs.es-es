...
En esta sección, creará un usuario llamado Britta Simon en Tidemark. Trabaje con el  [equipo de soporte técnico de Tidemark](http://www.tidemark.com/contact-us) para agregar los usuarios en la plataforma de Tidemark. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.
