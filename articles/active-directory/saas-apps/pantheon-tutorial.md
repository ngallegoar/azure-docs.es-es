...
## <a name="configure-and-test-azure-ad-single-sign-on-for-pantheon"></a>Configuración y prueba del inicio de sesión único de Azure AD para Pantheon
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Pantheon** , busque la sección **Administrar** y seleccione **Inicio de sesión único** .
...
- [Prueba de Pantheon con Azure AD](https://aad.portal.azure.com/)