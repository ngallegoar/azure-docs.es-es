...
1. En la página de integración de la aplicación [SAP HANA](https://portal.azure.com/) de **Azure Portal**, haga clic en **Inicio de sesión único**.
