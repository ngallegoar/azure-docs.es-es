...
- [Cómo proteger Greenlight Integration Platform con visibilidad y controles avanzados](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)