...
* Una vez configurado E-days, puede aplicar el control de sesión, que protege la filtración y la infiltración de la información confidencial de la organización en tiempo real. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-e-days"></a>Configuración y prueba del inicio de sesión único de Azure AD para E-days
...
Para configurar y probar el inicio de sesión único de Azure AD con E-days, es preciso completar los siguientes bloques de creación:
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **E-days** , busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
Al hacer clic en el icono de E-days del Panel de acceso, debería iniciar sesión automáticamente en la instancia de E-days para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Prueba de E-days con Azure AD](https://aad.portal.azure.com/)
