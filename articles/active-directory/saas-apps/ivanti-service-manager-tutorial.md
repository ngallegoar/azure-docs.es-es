...
Para que el inicio de sesión único funcione, es necesario establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Ivanti Service Manager (ISM).
...
Al hacer clic en el icono de Ivanti Service Manager (ISM) en el Panel de acceso, debería iniciar sesión automáticamente en la instancia de Ivanti Service Manager (ISM) para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
