...
## <a name="configure-and-test-azure-ad-single-sign-on-for-pluralsight"></a>Configuración y prueba del inicio de sesión único de Azure AD para Pluralsight
...
Para configurar y probar el inicio de sesión único de Azure AD con Pluralsight, complete los siguientes bloques de creación:
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Pluralsight** , busque la sección **Administrar** y seleccione **Inicio de sesión único** .
...
1. En la sección **Configuración básica de SAML** , especifique los valores de los siguientes campos:
    ...
    b. En el cuadro de texto **Identificador** , escriba una dirección URL con el siguiente patrón: `www.pluralsight.com`
...
- [Prueba de Pluralsight con Azure AD](https://aad.portal.azure.com/)