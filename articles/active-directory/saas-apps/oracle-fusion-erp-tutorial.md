...
## <a name="adding-oracle-fusion-erp-from-the-gallery"></a>Adición de Oracle Fusion ERP desde la galería
...
Para configurar y probar el inicio de sesión único de Azure AD con Oracle Fusion ERP, es preciso completar los siguientes bloques de creación:
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **Oracle Fusion ERP** , busque la sección **Administrar** y seleccione **Inicio de sesión único** .
...
Al hacer clic en el icono de Oracle Fusion ERP en el panel de acceso debería iniciar sesión automáticamente en la versión de Oracle Fusion ERP para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Pruebe Oracle Fusion ERP con Azure AD](https://aad.portal.azure.com/).