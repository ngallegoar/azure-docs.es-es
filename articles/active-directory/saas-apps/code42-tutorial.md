...
Al hacer clic en el icono de Code42 en el panel de acceso, iniciará sesión automáticamente en la instancia de Code42 para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
