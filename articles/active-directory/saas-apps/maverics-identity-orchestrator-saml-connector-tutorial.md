...
1. [Cree una instancia de Key Vault](../../key-vault/secrets/quick-create-portal.md#create-a-vault).
...
1. Abra la [CLI de Azure](/cli/azure/install-azure-cli?view=azure-cli-latest) y, luego, escriba el siguiente comando:
