...
En esta sección creará un usuario llamado B.Simon en Blue Access for Members (BAM). Trabaje con el  [equipo de soporte técnico de Blue Access for Members (BAM)](https://www.bcbstx.com/contact-us) para agregar los usuarios a la plataforma de la aplicación. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.
