...
* Suscripción de LoginRadius con el inicio de sesión único habilitado
...
4. En la sección **Configuración básica de SAML**, siga estos pasos:
    ...
    b. En el cuadro de texto **Identificador (Id. de entidad)** , escriba una dirección URL: `https://LoginRadius.hub.loginradius.com/`
...
6. En la sección **Set up LoginRadius** (Configurar LoginRadius), copie las direcciones URL adecuadas según sus necesidades.
...
Para configurar el inicio de sesión único en **LoginRadius**, es preciso enviar el **XML de metadatos** descargado y las direcciones URL apropiadas copiadas de Azure Portal al [equipo de soporte técnico de LoginRadius](mailto:support@loginradius.com). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
Al hacer clic en el icono de LoginRadius del panel de acceso, debería iniciar sesión automáticamente en la versión de LoginRadius para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
