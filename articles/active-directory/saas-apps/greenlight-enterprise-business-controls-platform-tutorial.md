...
* Una vez configurado Greenlight Enterprise Business Controls Platform, puede aplicar controles de sesión que protejan la filtración e infiltración de la información confidencial de la organización en tiempo real. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Cloud App Security](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app).
...
En esta sección, creará un usuario llamado B.Simon en Greenlight Enterprise Business Controls Platform. Colabore con el  [equipo de soporte técnico de GreenLight Enterprise Business Controls Platform](mailto:support@greenlightcorp.com) para agregar los usuarios a Greenlight Enterprise Business Controls Platform. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.
...
- [Protección de Greenlight Enterprise Business Controls Platform con visibilidad y controles avanzados](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)