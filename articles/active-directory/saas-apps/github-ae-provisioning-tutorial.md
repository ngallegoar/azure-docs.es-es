...
> * Inicio de sesión único en [GitHub AE](https://docs.microsoft.com/azure/active-directory/saas-apps/github-ae-tutorial) (recomendado)
...
3. Determine qué datos quiere [asignar entre Azure AD y GitHub AE](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
