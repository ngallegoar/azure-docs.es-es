...
En esta sección, creará un usuario llamado Britta Simon en Autotask Endpoint Backup. Colabore con el [equipo de soporte técnico de Autotask Endpoint Backup](https://backup.autotask.net/help/Content/0_HOME/_AutotaskCustomerSupport.htm) para agregar los usuarios en la plataforma Autotask Endpoint Backup. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.
