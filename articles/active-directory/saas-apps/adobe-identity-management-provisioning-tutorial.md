...
3. Determine qué datos [asignar entre Azure AD y Adobe Identity Management](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
