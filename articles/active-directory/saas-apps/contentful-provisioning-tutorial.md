...
> * [Inicio de sesión único](https://docs.microsoft.com/azure/active-directory/saas-apps/contentful-tutorial) en Contentful (recomendado)
...
3. Determine qué datos quiere [asignar entre Azure AD y Contentful](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
