...
## <a name="adding-surveymonkey-enterprise-from-the-gallery"></a>Adición de SurveyMonkey Enterprise desde la galería
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-surveymonkey-enterprise"></a>Configuración y prueba del inicio de sesión único de Azure AD para SurveyMonkey Enterprise
...
Para configurar y probar el inicio de sesión único (SSO) de Azure AD con SurveyMonkey Enterprise, es preciso completar los siguientes bloques de creación:
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **SurveyMonkey Enterprise**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
Al hacer clic en el icono de SurveyMonkey Enterprise del panel de acceso, debería iniciar sesión automáticamente en la versión de SurveyMonkey Enterprise para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Pruebe SurveyMonkey Enterprise con Azure AD](https://aad.portal.azure.com/)