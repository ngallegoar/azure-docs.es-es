...
En esta sección, creará un usuario llamado Britta Simon en IMAGE WORKS. Trabaje conjuntamente con el  [equipo de soporte técnico en IMAGE WORKS](mailto:iw-sd-support@fujifilm.com) para agregar usuarios a la plataforma de IMAGE WORKS. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.
