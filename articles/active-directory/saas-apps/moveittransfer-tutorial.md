...
1. En la página de integración de la aplicación [MOVEit Transfer - Azure AD integration](https://portal.azure.com/) de **Azure Portal**, haga clic en **Inicio de sesión único**.
