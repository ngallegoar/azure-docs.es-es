...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de OneTrust Privacy Management Software.
...
2. **[Configuración del inicio de sesión único de OneTrust Privacy Management Software](#configure-onetrust-privacy-management-software-single-sign-on)** : para configurar los valores de inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de OneTrust Privacy Management Software](#create-onetrust-privacy-management-software-test-user)** : para tener un homólogo de Britta Simon en OneTrust Privacy Management Software que esté vinculado a la representación de ella en Azure AD.
...
Para configurar el inicio de sesión único de Azure AD con OneTrust Privacy Management Software, realice los siguientes pasos:

1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **OneTrust Privacy Management Software**, seleccione **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, si desea configurar la aplicación en el modo iniciado por **IDP** siga estos pasos:
    ...
    ![Información de inicio de sesión único de dominio y direcciones URL de OneTrust Privacy Management Software](common/idp-intiated.png)

    a. En el cuadro de texto **Identificador**, escriba una dirección URL: `https://www.onetrust.com/saml2`
...
5. Haga clic en **Establecer direcciones URL adicionales** y siga este paso si desea configurar la aplicación en el modo iniciado por **SP**:
    ...
    ![Información de inicio de sesión único de dominio y direcciones URL de OneTrust Privacy Management Software](common/metadata-upload-additional-signon.png)
...
### <a name="configure-onetrust-privacy-management-software-single-sign-on"></a>Configuración del inicio de sesión único de OneTrust Privacy Management Software
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y, luego, **OneTrust Privacy Management Software**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **OneTrust Privacy Management Software**.

    ![El vínculo de OneTrust Privacy Management Software en la lista de aplicaciones](common/all-applications.png)
...
Al hacer clic en el icono de OneTrust Privacy Management Software en el Panel de acceso, debería iniciar sesión automáticamente en la instancia de OneTrust Privacy Management Software para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
