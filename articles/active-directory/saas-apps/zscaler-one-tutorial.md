...
1. En la página de integración de aplicaciones de [Zscaler One](https://portal.azure.com/) de **Azure Portal**, seleccione **Inicio de sesión único**.
