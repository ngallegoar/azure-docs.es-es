...
- [API de acceso condicional](/graph/api/resources/conditionalaccesspolicy?view=graph-rest-1.0)

- [API de ubicación con nombre](/graph/api/resources/namedlocation?view=graph-rest-1.0)