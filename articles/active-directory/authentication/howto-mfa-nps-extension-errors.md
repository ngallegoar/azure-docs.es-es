---
title: 'Solucionar problemas de extensión NPS de Azure MFA: Azure Active Directory'
description: Ayuda para solucionar problemas con la extensión de NPS para Azure Multi-Factor Authentication
