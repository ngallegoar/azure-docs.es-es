...
- [Seguimiento de estado](../hybrid/whatis-hybrid-identity-health.md): puede proporcionar una sólida supervisión y una ubicación central en Azure Portal para ver esta actividad. 
