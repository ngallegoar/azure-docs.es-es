...
| - | - |
| Emisor del proveedor de identidades| [https://sts.windows.net/{tenant-id}/](https://sts.windows.net/{tenant-id}/) |
...
* Indique a los usuarios que use el [Panel de acceso](https://myapps.microsoft.com.com/) para acceder a todas las aplicaciones migradas. 
