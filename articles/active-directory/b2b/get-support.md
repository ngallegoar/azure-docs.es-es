---
title: 'Obtención de soporte de la colaboración B2B: Azure Active Directory'
...
1. En [Azure portal](https://portal.azure.com), vaya a la hoja Ayuda y soporte técnico y seleccione Nueva solicitud de soporte:
   ...
   ![Captura de pantalla que muestra una nueva solicitud de soporte técnico](media/get-support/new-support-request.png)
...
2. Describa el problema:
   ...
   ![Captura de pantalla que muestra la descripción del problema de una incidencia de soporte técnico](media/get-support/problem-description.png)
