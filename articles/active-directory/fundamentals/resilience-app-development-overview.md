...
![Imagen de la aplicación que llama a la plataforma de identidad de Microsoft](media/resilience-app-development-overview/app-overview.png)
...
- [Aumento de la resistencia en la infraestructura de administración de identidades y acceso](resilience-in-infrastructure.md)
- [Aumento de la resistencia en la administración de identidades y acceso de clientes con Azure Active Directory B2C](resilience-b2c.md)