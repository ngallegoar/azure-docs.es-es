...
- Para obtener más información acerca de las asignaciones de roles de Azure AD, consulte [Asignación de roles de administrador](directory-assign-admin-roles.md).
