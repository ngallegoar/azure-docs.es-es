---
title: 'Inicio rápido: Cambio de los tipos de cuenta que admite una aplicación | Azure'
...
En este inicio rápido, aprenderá a modificar la configuración de la aplicación para cambiar quién o qué tipos de cuentas pueden acceder a la aplicación.
...
Para más información sobre cómo configurar un dominio de publicador comprobado, consulte [Configuración de un dominio comprobado](quickstart-modify-supported-accounts.md).

## <a name="next-steps"></a>Pasos siguientes

> [!div class="nextstepaction"]
> [Cómo: Conversión de la aplicación en multiinquilino](howto-convert-app-to-be-multi-tenant.md)
