...
description: Aprenda a compilar una API web protegida (pasar a producción).
...
ms.locfileid: "81537192"
---
# <a name="protected-web-api---move-to-production"></a>API web protegida: pasar a producción

Ahora que sabe cómo proteger su API web, le mostramos cómo puede moverla a producción.
