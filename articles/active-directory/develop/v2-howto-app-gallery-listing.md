---
title: Incorporación de una aplicación a la galería de aplicaciones de Azure AD | Microsoft Docs
...
ms.locfileid: "88118848"
---
# <a name="add-your-application-to-the-azure-active-directory-application-gallery"></a>Incorporación de su aplicación en la galería de aplicaciones de Azure Active Directory
...
- **OpenID Connect**: para integrar la aplicación con Azure AD mediante el protocolo OpenID Connect, siga las [instrucciones de los desarrolladores](../azuread-dev/v1-authentication-scenarios.md).
