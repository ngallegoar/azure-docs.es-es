...
RBAC de Azure AD habilita que la empresa restrinja la cantidad de operaciones que una persona puede hacer una vez que acceden a Azure Portal. Si se usa RBAC para controlar el acceso al portal, los administradores de TI pueden delegar el acceso con los siguientes enfoques de administración de acceso:
