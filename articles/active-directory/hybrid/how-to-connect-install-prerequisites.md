...
* Si usa la ruta de instalación de configuración personalizada, dispone de más opciones; vea [Cuentas de Active Directory](reference-connect-accounts-permissions.md#custom-installation-settings).
