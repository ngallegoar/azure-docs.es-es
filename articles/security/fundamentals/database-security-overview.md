...
Uno de los problemas existentes a la hora de administrar una red, es el de proteger los datos que se envían entre aplicaciones a través de una red que no es de confianza. Puede usar [TLS/SSL](/windows-server/security/tls/transport-layer-security-protocol) para autenticar servidores y clientes y usarlo para cifrar mensajes entre las partes autenticadas.
...
![Característica Always Encrypted ilustrada como un candado y una clave](./media/database-security-overview/azure-database-fig1.png)
...
![Enmascarar un número que se envía entre una base de datos de SQL y aplicaciones empresariales](./media/database-security-overview/azure-database-fig3.png)
...
La [auditoría de Azure SQL Database](/azure/sql-database/sql-database-auditing-get-started) aumenta la capacidad de obtener información sobre los eventos y los cambios que se producen en la base de datos. Algunos ejemplos son las actualizaciones y las consultas efectuadas en los datos.
...
La [protección avanzada contra amenazas en Azure SQL Database](/azure/sql-database/sql-advanced-threat-protection) detecta actividades sospechosas que indican posibles amenazas de seguridad. La detección de amenazas le permite responder a eventos sospechosos en la base de datos (como las inserciones de SQL) en el momento en que se producen. Asimismo, proporciona alertas y permite usar la auditoría de Azure SQL Database para explorar eventos sospechosos.

![Detección de amenazas de SQL Database y una aplicación web, con un atacante externo y una persona interna malintencionada](./media/database-security-overview/azure-database-fig5.jpg)
...
[Advanced Threat Protection para Azure Database for MySQL](/azure/mysql/concepts-data-access-and-security-threat-protection) proporciona una protección similar a la protección avanzada de PostgreSQL.  
...
[Security Center](../../security-center/security-center-alerts-data-services.md) ayuda a proteger los datos de SQL Database ofreciendo visibilidad sobre la seguridad en todos los servidores y bases de datos. Con Security Center puede realizar estas tareas:
...
Puede configurar las [directivas de SQL Information Protection](/azure/security-center/security-center-info-protection-policy) en Azure Security Center.
...
- [Protección de las bases de datos de Azure SQL](/azure/sql-database/sql-database-security-tutorial)
- [Servicios Azure Security Center y Azure SQL Database](/azure/security-center/security-center-sql-database)
- [Detectar amenazas de SQL Database](/azure/sql-database/sql-database-threat-detection)
- [Mejorar el rendimiento de SQL Database](/azure/sql-database/sql-database-performance-tutorial)
