...
|[Almacenamiento de blobs de Azure](https://docs.microsoft.com/azure/storage/blobs/)|*.blob.core.windows.net|
|[Azure Cloud Services](https://docs.microsoft.com/azure/cloud-services/cloud-services-choose-me) y [Azure Virtual Machines](https://docs.microsoft.com/azure/virtual-machines/)|*.cloudapp.net|
...
|[Archivos de Azure](https://docs.microsoft.com/azure/storage/files/storage-files-introduction)|*.file.core.windows.net|
