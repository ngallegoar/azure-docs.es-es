...
En este artículo se describe cómo trabajar con configuraciones de ámbito al usar la característica [Change Tracking e Inventario](change-tracking.md) para implementar cambios en las VM. Para obtener más información, consulte [Soluciones de supervisión como destino en Azure Monitor (versión preliminar)](../azure-monitor/insights/solution-targeting.md). 
