...
11. En el área **Scripts previos + scripts posteriores (versión preliminar)** , seleccione los scripts que se van a ejecutar antes y después de la implementación. Para más información, consulte [Administración de scripts previos y posteriores](update-mgmt-pre-post-scripts.md).
