...
- [Descripción de las detecciones de riesgo de Azure Security Center (actividad sospechosa)](/azure/active-directory/reports-monitoring/concept-risk-events)
...
Controle el acceso a los recursos de Azure a través de Azure Active Directory el control de acceso basado en rol.
...
Revise las opciones para controlar la exposición de su servicio a través de la configuración "Visibilidad". in Private Link. Esta configuración de visibilidad decide si un consumidor puede conectarse a su servicio. 
