...
|Private Link para los servicios PaaS de Azure   | Azure Storage        |  Todas las regiones públicas      | GA <br/> [Más información](/azure/storage/common/storage-private-endpoints)  |
