...
ms.locfileid: "83871492"
---
# <a name="azure-database-for-mysql-use-net-c-to-connect-and-query-data"></a>Azure Database for MySQL: Uso de .NET (C#) para conectarse a los datos y consultarlos
