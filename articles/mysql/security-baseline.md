...
description: Línea de base de seguridad de Azure para Azure Database for MySQL
author: msmbaldwin
ms.service: security
ms.topic: conceptual
ms.date: 03/23/2020
...
Configuración de Private Link para Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/howto-configure-privatelink-portal

Creación y administración de reglas y puntos de conexión de servicio de red virtual de Azure Database for MySQL: https://docs.microsoft.com/azure/sql-database/sql-database-vnet-service-endpoint-rule-overview

Configuración de reglas de firewall para Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/howto-manage-firewall-using-portal
...
Configuración de Advanced Threat Protection para Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/howto-database-threat-protection-portal
...
Descripción del uso de etiquetas de servicio para Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/concepts-data-access-and-security-vnet#terminology-and-description
...
Descripción de los registros de servidor en Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/concepts-monitoring#server-logs
...
Configuración y acceso a los registros de consultas lentas de Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/howto-configure-server-logs-in-portal

Configuración y acceso a los registros de auditoría de Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/howto-configure-audit-logs-portal
...
Habilitación de Advanced Threat Protection para Azure Database for MySQL (versión preliminar): https://docs.microsoft.com/azure/mysql/howto-database-threat-protection-portal
...
Descripción de las operaciones del proveedor de recursos de Azure Database for MySQL: https://docs.microsoft.com/azure/role-based-access-control/resource-provider-operations#microsoftdbformysql

Descripción de la administración de acceso de Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/concepts-security#access-management
...
Creación de cuentas adicionales en Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/howto-create-users

Actualización de la contraseña del administrador: https://docs.microsoft.com/azure/mysql/howto-create-manage-server-portal#update-admin-password
...
Descripción sobre cómo crear usuarios administradores en Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/howto-create-users
...
Uso de Azure Active Directory para la autenticación con Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/howto-configure-sign-in-azure-ad-authentication

Descripción de la API REST de Azure Database for MySQL: https://docs.microsoft.com/rest/api/mysql/
...
Cómo integrar los registros de actividad de Azure en Azure Monitor: https://docs.microsoft.com/azure/active-directory/reports-monitoring/howto-integrate-activity-logs-with-log-analytics
...
Configuración de Private Link para Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/concepts-data-access-security-private-link

Creación y administración de reglas y puntos de conexión de servicio de red virtual de Azure Database for MySQL: https://docs.microsoft.com/azure/sql-database/sql-database-vnet-service-endpoint-rule-overview

Configuración de reglas de firewall para Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/concepts-firewall-rules
...
Mitigación de la filtración de datos para Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/concepts-data-access-security-private-link#data-exfiltration-prevention
...
Configuración del cifrado en tránsito para Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/concepts-ssl-connection-security
...
Configuración del acceso de usuario con SQL para Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/howto-create-users
...
Descripción del cifrado en reposo de Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/concepts-security

Configuración de claves administradas por el cliente para Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/concepts-data-encryption-mysql
...
**Guía**: Actualmente, no está disponible. Azure Security Center todavía no admite la evaluación de vulnerabilidades para Azure Database for MySQL.
...
**Guía**: La instancia de Azure Database for MySQL admite la autenticación de Azure Active Directory (en versión preliminar) para tener acceso a las bases de datos.  Al crear la instancia de Azure Database for MySQL, se deben proporcionar las credenciales de un usuario administrador. Este administrador se puede usar para crear más usuarios de base de datos.  
...
Descripción de las copias de seguridad para Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/concepts-backup

Descripción de la configuración inicial de Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/tutorial-design-database-using-portal
...
Descripción de las copias de seguridad para Azure Database for MySQL: https://docs.microsoft.com/azure/mysql/howto-restore-server-portal 
