...
description: Esta guía de inicio rápido le ayudará a usar Azure Portal para crear rápidamente un servidor de Azure Database for MySQL de ejemplo en unos cinco minutos.
author: ajlam
ms.author: andrela
ms.service: mysql
ms.custom: mvc
