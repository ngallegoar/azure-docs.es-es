...
* **Nota**: Para solucionar errores de validación de un certificado SSL, vea [http://readthedocs.org/docs/twilio-php/en/latest/usage/rest.html][ssl_validation] 
