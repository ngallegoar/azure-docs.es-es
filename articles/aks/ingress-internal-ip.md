...
Este artículo usa [Helm 3][helm] para instalar el controlador de entrada NGINX. Asegúrese de que está usando la versión más reciente de Helm y de que tiene acceso al repositorio *stable* de Helm. Para obtener más información sobre cómo configurar y usar Helm, consulte [Instalación de aplicaciones con Helm en Azure Kubernetes Service (AKS)][use-helm].
