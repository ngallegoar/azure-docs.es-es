...
Este artículo usa [Helm 3][helm] para instalar el controlador de entrada NGINX. Asegúrese de que está usando la versión más reciente de Helm y de que tiene acceso al repositorio *stable* de Helm.
