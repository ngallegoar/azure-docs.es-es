---
title: 'Configuración del motor de reglas: Azure Front Door'
description: En este artículo se describe cómo configurar los motores de reglas para Azure Front Door.
services: frontdoor
documentationcenter: ''
author: megan-beatty
editor: ''
