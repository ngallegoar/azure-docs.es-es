---
title: 'Tutorial: Configuración de cachés en Azure Redis Cache mediante Ansible'
description: Obtenga información sobre cómo usar Ansible para crear, escalar, reiniciar y agregar una regla de firewall en Azure Redis Cache
