---
title: 'Tutorial: Configuración de un clúster de Azure HDInsight con Ansible'
description: Obtenga información sobre cómo usar Ansible para crear, eliminar y cambiar el tamaño de un clúster de Azure HDInsight
