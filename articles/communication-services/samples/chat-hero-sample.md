...
5. Actualice ENVIRONMENT_URL en `./Chat/ClientApp/src/constants.tsx` con la ubicación del recurso. (Por ejemplo, https://<RESOURCE_NAME>.communication.azure.com).
