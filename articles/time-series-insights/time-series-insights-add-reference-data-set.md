...
- Para obtener una referencia completa de la API, lea el documento [API de datos de referencia](https://docs.microsoft.com/rest/api/time-series-insights/gen1-reference-data-api).
