...
Lea acerca de la ingesta de datos en Azure Time Series Insights:

> [!div class="nextstepaction"]
> [Introducción a la ingesta de datos en Azure Time Series Insights](./concepts-ingestion-overview.md)

Obtenga más información sobre los modelos de serie temporal:

> [!div class="nextstepaction"]
> [Modelado de datos de la versión preliminar de Azure Time Series Insights](./concepts-model-overview.md)
