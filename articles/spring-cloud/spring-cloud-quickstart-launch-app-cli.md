...
Azure Spring Cloud permite ejecutar fácilmente en Azure una aplicación de microservicios basada en Spring Boot.  Antes ejecutar este ejemplo, pruebe el [inicio rápido básico](spring-cloud-quickstart.md).
...
3. Vaya hasta la dirección URL proporcionada por el comando anterior para ejecutar la aplicación PiggyMetrics.
    ![Ejecución de PiggyMetrics](media/spring-cloud-quickstart-launch-app-cli/launch-app.png)
...
3. Seleccione **gateway**.
    ...
    ![Desplazamiento por PiggyMetrics](media/spring-cloud-quickstart-launch-app-cli/navigate-app1.png)
    
4. Busque la dirección URL en la página **Información general de gateway**![Desplazamiento por PiggyMetrics 2](media/spring-cloud-quickstart-launch-app-cli/navigate-app2-url.png)
