...
* Para obtener más información acerca de cómo trabajar con Azure RBAC, consulte [¿Qué es el control de acceso basado en roles de Azure (Azure RBAC)?](../role-based-access-control/overview.md)
