...
1. Asegúrese de que el servidor principal y el secundarios se encuentran en una [región emparejada](/azure/best-practices-availability-paired-regions). 
