...
> [!IMPORTANT]
> En los grupos densos con muchas bases de datos activas, puede no ser factible aumentar el número de bases de datos del grupo hasta los máximos documentados para los grupos elásticos por [DTU](sql-database-dtu-resource-limits-elastic-pools.md) y [núcleo virtual](sql-database-vcore-resource-limits-elastic-pools.md).
> 
