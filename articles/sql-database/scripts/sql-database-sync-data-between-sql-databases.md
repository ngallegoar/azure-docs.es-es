---
title: 'Ejemplo de PowerShell: sincronización entre varias bases de datos de Azure SQL'
...
- Crear una base de datos de SQL Server local como base de datos miembro
