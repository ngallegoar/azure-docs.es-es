---
title: Ejemplo de CLI la importación de un archivo de BACPAC en una base de datos de Azure SQL
description: Script de ejemplo de la CLI de Azure para importar un archivo BACPAC en una base de datos SQL
...
ms.locfileid: "80061830"
---
# <a name="use-cli-to-import-a-bacpac-file-into-an-azure-sql-database"></a>Uso de la CLI para importar un archivo BACPAC en una base de datos de Azure SQL

Este ejemplo de script de la CLI de Azure importa una base de datos de un archivo *.bacpac* a una base de datos de Azure SQL.  
