...
1. Cree un servidor de Azure SQL Database en la región de destino si aún no tiene un servidor adecuado ahí.  Este servidor debe pertenecer a la misma suscripción que el servidor original (origen).
