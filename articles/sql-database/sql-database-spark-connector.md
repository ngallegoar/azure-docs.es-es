---
title: Conector de Spark con Azure SQL Database y SQL Server
...
En el siguiente diagrama se ilustra el flujo de datos.
   ...
   ![arquitectura](./media/sql-database-spark-connector/architecture.png)
...
Puede conectarse a Azure SQL Database mediante la autenticación de Azure Active Directory (AAD). Use la autenticación de AAD para administrar identidades de usuarios de base de datos de forma centralizada y como alternativa a la autenticación de SQL Server.
...
Consulte [Use Azure Active Directory Authentication for authentication with SQL Database](sql-database-aad-authentication.md) (Uso de la autenticación de Azure Active Directory con SQL Database ) para obtener información sobre cómo obtener un token de acceso para su base de datos de Azure SQL.
