---
title: Uso de la biblioteca de cliente de bases de datos elásticas con Dapper
...
La integración de **Dapper** y **DapperExtensions** con la biblioteca de cliente de bases de datos elásticas para Azure SQL Database es sencilla. Las aplicaciones pueden usar el enrutamiento dependiente de los datos cambiando la creación y apertura de nuevos objetos [SqlConnection](https://msdn.microsoft.com/library/system.data.sqlclient.sqlconnection.aspx) para que usen la llamada [OpenConnectionForKey](https://msdn.microsoft.com/library/azure/dn807226.aspx) desde la [biblioteca de cliente](https://msdn.microsoft.com/library/azure/dn765902.aspx). Esto limita los cambios en la aplicación a solo cuando se crean y se abren conexiones nuevas. 
...
## <a name="a-quick-look-at-the-elastic-database-client-library"></a>Una vista rápida a la biblioteca de cliente de bases de datos elásticas
...
En lugar de usar la forma tradicional de crear conexiones para Dapper, hay que usar el método [OpenConnectionForKey](https://msdn.microsoft.com/library/azure/dn824099.aspx). Esto garantiza que se lleva a cabo toda la validación y que las conexiones se administran correctamente cuando los datos se mueven entre las particiones.
