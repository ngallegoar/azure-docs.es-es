...
- Los destinos de nivel raíz que son servidores y bases de datos se migrarán a un nuevo grupo de destino llamado "(\<nombre_servidor\>, \<nombre_base_de_datos\>)" que contiene solo el destino de nivel raíz.
...
- Los trabajos con varios desencadenadores con diferentes programaciones se separan en varios trabajos con el esquema de nomenclatura: "\<nombre_del_trabajo\> (\<nombre_de_la_programación\>)".
