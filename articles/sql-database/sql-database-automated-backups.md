...
> [!NOTE]
> La retención mínima de copia de seguridad de recuperación a un momento dado que se puede configurar para bases de datos únicas agrupadas e instancias administradas mediante Azure Portal es de 7 días. La retención mínima de copia de seguridad de recuperación a un momento dado de 1 día se puede configurar para la instancia administrada solo con PowerShell con el módulo As.SQL v2.6.0 o posterior.
