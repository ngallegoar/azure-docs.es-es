...
| --- | --- |
|[CREATE DATABASE (Azure SQL Database)](/sql/t-sql/statements/create-database-azure-sql-database)|Crea una nueva base de datos. Debe estar conectado a la base de datos maestra para crear una base de datos.|
