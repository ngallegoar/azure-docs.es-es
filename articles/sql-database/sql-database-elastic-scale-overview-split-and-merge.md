...
- **Partición de destino (división)**
  ...
  Una vez que haya proporcionado la información sobre el origen de la operación de división, debe definir dónde desea copiar los datos, para lo cual debe proporcionar el nombre de la base de datos y el servidor de base de datos SQL de Azure de destino.
