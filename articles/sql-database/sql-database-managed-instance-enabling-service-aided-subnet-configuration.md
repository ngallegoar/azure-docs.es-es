---
title: Habilitación de la configuración de subred asistida por servicio para Instancia administrada de Azure SQL Database
...
> [!IMPORTANT] 
> Cuando la delegación de subred está activada, no puede desactivarla hasta que quite el último clúster virtual de la subred. Para obtener más información sobre cómo eliminar un clúster virtual, consulte el siguiente [artículo](sql-database-managed-instance-delete-virtual-cluster.md#delete-virtual-cluster-from-the-azure-portal).
