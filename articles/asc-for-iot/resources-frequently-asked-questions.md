---
title: Preguntas frecuentes sobre Azure Security Center para IoT| Microsoft Docs
...
2. Cree su propio agente e implemente el esquema de mensajes de seguridad de Microsoft Azure Security Center para IoT. Esta opción permite el uso de las herramientas de análisis de Microsoft Azure Security Center para IoT, además del agente de seguridad de los dispositivos.
...
El agente de seguridad de Azure Security Center para IoT es de código abierto y está disponible en GitHub para Windows y Linux en versiones de 32 y 64 bits: https://github.com/Azure/Azure-Security-IoT.
...
3. Compruebe que el dispositivo esté [configurado en IoT Hub con el módulo de Azure Security Center para IoT](quickstart-create-security-twin.md).  
