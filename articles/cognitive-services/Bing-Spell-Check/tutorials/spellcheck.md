...
Cree un formulario HTML con un campo de texto. Controle el evento **onsubmit** y llame a la función bingSpellCheck, pasando el contenido del campo de texto y la clave de Bing Spell Check API.
