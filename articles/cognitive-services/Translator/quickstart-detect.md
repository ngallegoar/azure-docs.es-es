---
title: 'Inicio rápido: Detección del idioma del texto en la API Translator Text'
titleSuffix: Azure Cognitive Services
description: En este inicio rápido, obtendrá información sobre cómo detectar el idioma del texto proporcionado mediante la API REST Translator Text.
