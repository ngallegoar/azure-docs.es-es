...
description: En este artículo se muestra cómo suscribirse a la Translator Text API de Azure Cognitive Services y obtener una clave de suscripción.
