...
Para obtener una lista completa de opciones y parámetros consulte [Bing Web Search API v7](/rest/api/cognitiveservices-bingsearch/bing-web-api-v7-reference).
