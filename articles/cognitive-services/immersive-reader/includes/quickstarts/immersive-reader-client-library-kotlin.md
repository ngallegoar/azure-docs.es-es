...
![Implementaciones de aplicación Gradle](../../media/android/kotlin/android-studio-build-gradle.png)
...
![Cree un archivo HTML.](../../media/android/kotlin/android-studio-immersive-reader-html.png)
