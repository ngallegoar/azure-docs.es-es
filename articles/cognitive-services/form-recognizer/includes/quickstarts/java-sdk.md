...
Vaya a la nueva carpeta y cree un archivo llamado *formrecognizer-quickstart.java*. Ábralo en el editor o el IDE que prefiera y agregue las siguientes instrucciones `import`:
