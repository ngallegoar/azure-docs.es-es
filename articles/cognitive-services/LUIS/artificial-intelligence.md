...
description: LUIS usa la inteligencia artificial para proporcionar comprensión del lenguaje sobre los datos, en función del esquema que se haya definido.
ms.topic: conceptual
ms.date: 06/29/2020
...
LUIS usa la inteligencia artificial para proporcionar comprensión del lenguaje natural (NLU) sobre los datos, en función del esquema que se haya definido.
...
* [Comprensión del lenguaje natural](#natural-language-understanding) (LUIS)
