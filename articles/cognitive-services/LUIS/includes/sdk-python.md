...
Coloque el siguiente método encima del método `quickstart` para buscar el identificador de la subentidad de Quantity, con el fin de asignar las características a esa subentidad.
