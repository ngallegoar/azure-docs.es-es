...
|----------|-----------|----------|--------------|
|<a name="count" />count|El número de resultados para devolver, empezando por el índice especificado por el parámetro `offset`.|String|No|   
...
|<a name="offset"/>offset|El índice de inicio de resultados especificados por el parámetro `count`.|Entero|No|  
