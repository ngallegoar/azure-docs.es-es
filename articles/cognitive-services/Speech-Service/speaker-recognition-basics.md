---
title: 'Conceptos básicos del reconocimiento del hablante: servicio de voz'
titleSuffix: Azure Cognitive Services
description: Aprenda a usar el SDK de Voz para responder a la pregunta "quién está hablando". En este artículo, obtendrá información sobre los patrones de diseño comunes para trabajar con la comprobación y la identificación del hablante.
...
ms.locfileid: "84632301"
---
# <a name="learn-the-basics-of-speaker-recognition"></a>Aspectos básicos del reconocimiento del hablante

En este artículo, aprenderá los patrones de diseño básicos de Speaker Recognition mediante el SDK de Voz, que incluyen:
