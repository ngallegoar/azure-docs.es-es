---
title: 'Inicio rápido: Traducción de voz a texto en C# (.NET Core y Windows): servicio de voz'
...
1. Reemplace la cadena `YourServiceRegion` por la [región](~/articles/cognitive-services/Speech-Service/regions.md).
