...
1. Vaya a [Pruebe Cognitive Services](https://azure.microsoft.com/free/cognitive-services).
...
- Si la aplicación usa [SDK de Voz](speech-sdk.md), proporcione el identificador de región, por ejemplo, `westus`, al crear una configuración de voz.
