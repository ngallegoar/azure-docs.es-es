---
title: 'Inicio rápido: Reconocimiento de voz en Swift: servicio de Voz (iOS)'
titleSuffix: Azure Cognitive Services
description: Obtenga información sobre cómo crear una aplicación para reconocer la voz en Swift para un dispositivo iOS mediante el SDK de Voz de Cognitive Services.
