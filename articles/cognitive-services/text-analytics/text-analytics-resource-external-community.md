---
title: Contenido externo y de la comunidad para Text Analytics API
titleSuffix: Azure Cognitive Services
description: Blogs de asociados, vídeos de YouTube y entrenamiento para Cognitive Services Text Analytics API.
...
# <a name="external--community-content-for-the-text-analytics-cognitive-service"></a>Contenido externo y de la comunidad para Text Analytics en Cognitive Services
 ...
 Los vínculos de este artículo le llevan a contenido web útil desarrollado y producido por asociados y profesionales con experiencia en el uso de Text Analytics API.

## <a name="blogs"></a>Blogs

+ [Anuncio original de Text Analytics API (blog de Azure)](https://blogs.technet.microsoft.com/machinelearning/2015/04/08/introducing-text-analytics-in-the-azure-ml-marketplace/)
...
+ [Análisis de opiniones con Dynamics 365 CRM Online (blog de MSDN)](https://blogs.msdn.microsoft.com/geoffreyinnis/2016/07/11/sentiment-analysis-in-usd-with-cognitive-services-text-analytics/) 
...
+ [Identifique la opinión de los comentarios de un grupo de Yammer con MS Flow (comunidad técnica de Microsoft)](https://docs.microsoft.com/Yammer/integrate-yammer-with-other-apps/sentiment-analysis-flow-azure)



## <a name="videos"></a>Vídeos

+ [Aplicación lógica para detectar opiniones y extraer frases clave del texto](https://www.youtube.com/watch?v=jVN9NObAzgk)

+ [Análisis de opiniones con Power BI y Microsoft Cognitive Services](https://www.youtube.com/watch?v=gJ1j3N7Y75k)

+ [Frases clave de extracción de análisis de texto con Power BI y Microsoft Cognitive Services](https://www.youtube.com/watch?v=R_-1TB2BF14)
