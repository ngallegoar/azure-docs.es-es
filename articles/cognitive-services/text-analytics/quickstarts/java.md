...
ms.locfileid: "75446327"
---
# <a name="quickstart-use-java-to-call-the-azure-text-analytics-cognitive-service"></a>Inicio rápido: Uso de Java para llamar a Azure Text Analytics de Cognitive Services
<a name="HOLTop"></a>
