...
1. Con Visual Studio, abra la solución generada en el directorio `cmake` llamada `azure_iot_sdks.sln` y compílela mediante el comando **Compilar solución** del menú **Compilar**.
