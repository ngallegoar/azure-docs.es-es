...
3. Seleccione el botón de inserción ( **</>** ) que aparece debajo del vídeo.

    Después de seleccionar el botón **Insertar**, puede seleccionar el widget que quiera insertar en la aplicación.
