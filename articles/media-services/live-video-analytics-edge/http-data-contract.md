---
title: 'Contrato de datos de extensión HTTP: Azure'
description: En este artículo, obtendrá información sobre el uso del protocolo HTTP para enviar mensajes entre el módulo de Live Video Analytics y el módulo de inteligencia artificial o CV.
ms.topic: overview
ms.date: 09/14/2020
...
ms.locfileid: "88701961"
---
# <a name="http-extension-data-contract"></a>Contrato de datos de extensión HTTP

En este artículo, obtendrá información sobre el uso del protocolo HTTP para enviar mensajes entre el módulo de Live Video Analytics y el módulo de inteligencia artificial o CV.
...
![jerarquía de clases](./media/http-data-contract/class-hierarchy.png)
