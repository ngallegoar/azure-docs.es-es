...
- [Node.js](https://nodejs.org/), las versiones Active LTS y Maintenance LTS (se recomienda la 10.14.1). Use el comando `node --version` para comprobar la versión.
::: zone-end
::: zone pivot="programming-language-python"
