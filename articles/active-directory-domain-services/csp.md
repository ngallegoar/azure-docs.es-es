...
* **Los CSP pueden crear con scripts nuevos dominios administrados para sus clientes mediante PowerShell:** Consulte [cómo puede habilitar Azure AD Domain Services mediante PowerShell](powershell-create-instance.md) para ver detalles.
...
* [Habilitar Azure AD Domain Services mediante PowerShell](powershell-create-instance.md)
