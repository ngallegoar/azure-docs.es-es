...
Antes de unir a un dominio las máquinas virtuales y de implementar las aplicaciones que usan el dominio administrado de Azure AD DS, configure una red virtual de Azure para las cargas de trabajo de aplicación.
