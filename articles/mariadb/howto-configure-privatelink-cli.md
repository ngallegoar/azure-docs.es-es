...
Tenga en cuenta que el identificador del servidor MariaDB es similar a  ```/subscriptions/subscriptionId/resourceGroups/myResourceGroup/providers/Microsoft.DBforMariaDB/servers/servername.```. Utilizará el identificador del servidor MariaDB en el paso siguiente. 
