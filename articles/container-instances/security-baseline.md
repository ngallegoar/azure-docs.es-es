...
**Guía**: Azure Virtual Network proporciona seguridad, acceso de red seguro y privado para recursos locales y de Azure. Integre los grupos de contenedores de Azure Container Instances en una red virtual de Azure. 

* [Escenarios y recursos de red virtual: Azure Container Instances](https://docs.microsoft.com/azure/container-instances/container-instances-virtual-network-concepts)

* [Implementación de instancias de contenedor en una red virtual de Azure](https://docs.microsoft.com/azure/container-instances/container-instances-vnet)
...
* [Habilitación de los registros de flujo del grupo de seguridad de red](https://docs.microsoft.com/azure/network-watcher/network-watcher-nsg-flow-logging-portal)
...
* [Implementación en una red virtual: Azure Container Instances](https://docs.microsoft.com/azure/container-instances/container-instances-vnet) 
...
* [Exposición de una dirección IP estática para un grupo de contenedores](https://docs.microsoft.com/azure/container-instances/container-instances-application-gateway)
...
* [Ejecución de un comando en una instancia de contenedor de Azure en ejecución](https://docs.microsoft.com/azure/container-instances/container-instances-exec)
...
* [Registro de instancias y grupos de contenedores con registros de Azure Monitor](https://docs.microsoft.com/azure/container-instances/container-instances-log-analytics)
...
* [Registro de instancias y grupos de contenedores con registros de Azure Monitor](https://docs.microsoft.com/azure/container-registry/container-registry-diagnostics-audit-logs)
...
* [Montaje de un recurso compartido de archivos de Azure en Azure Container Instances](https://docs.microsoft.com/azure/container-instances/container-instances-volume-azure-files)
...
**Guía**: asegúrese de que los clientes que se conectan a los grupos de contenedores de Azure pueden negociar TLS 1.2 o superior. De forma predeterminada, los recursos de Microsoft Azure negociarán TLS 1.2.
...
* [Cifrado de datos de implementación con Azure Container Instances](https://docs.microsoft.com/azure/container-instances/container-instances-encrypt-data)
...
**Guía**: use Azure Monitor con el registro de actividad de Azure para crear alertas para cuando se produzcan cambios en los grupos de contenedores y las instancias de contenedor. 
...
* [Integración de Azure Container Registry con Security Center](https://docs.microsoft.com/azure/security-center/azure-container-registry-integration)
...
**Guía**: Microsoft realiza la administración de revisiones en los sistemas subyacentes que admiten contenedores en ejecución.
...
**Guía**: implemente soluciones para examinar las imágenes de contenedor de un registro privado e identificar posibles vulnerabilidades en las configuraciones del sistema operativo. Siga las recomendaciones de Azure Security Center para realizar evaluaciones de vulnerabilidades en las imágenes de contenedor almacenadas en Azure Container Registry. Opcionalmente, puede implementar soluciones de terceros de Azure Marketplace para realizar evaluaciones de vulnerabilidades de imagen.

Use una solución personalizada o de terceros para aplicar revisiones a las imágenes de contenedor. Si almacena imágenes de contenedor en Azure Container Registry, ejecute tareas de Azure Container Registry para automatizar las actualizaciones de las imágenes de aplicación de un registro de contenedor en función de las revisiones de seguridad u otras actualizaciones de las imágenes base del sistema operativo. 

* [Recomendaciones de seguridad de supervisión y examen de contenedores para Azure Container Instances](https://docs.microsoft.com/azure/container-instances/container-instances-image-security)
...
* [Cómo utilizar una identidad administrada con Azure Container Instances](https://docs.microsoft.com/azure/container-instances/container-instances-managed-identity)
...
* [Cifrado de datos de implementación: Azure Container Instances](https://docs.microsoft.com/azure/container-instances/container-instances-encrypt-data)
