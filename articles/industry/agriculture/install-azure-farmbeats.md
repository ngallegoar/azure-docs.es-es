...
Puede comprobar los permisos de acceso en Azure Portal si sigue las instrucciones del [Control de acceso basado en roles de Azure](https://docs.microsoft.com/azure/role-based-access-control/check-access).
