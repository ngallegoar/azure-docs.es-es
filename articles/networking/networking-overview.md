...
description: Obtenga información sobre los servicios de red en Azure, incluidos los servicios de conectividad, servicios de protección de aplicaciones, servicios de entrega de aplicaciones y supervisión de red.
services: networking
...
|[Microsoft Azure Peering Service (versión preliminar)](#azurepeeringservice)|Colaborar con proveedores de servicios para lograr un enrutamiento a la nube de Microsoft óptimo y confiable a través de la red pública.|<p>[Registro de Azure Peering Service](../peering-service/azure-portal.md)</p>|
||||
...
![Introducción al punto de conexión privado](./media/networking-overview/private-endpoint.png)
