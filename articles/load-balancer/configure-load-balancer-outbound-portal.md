...
3. Use estos valores para configurar la configuración de IP de front-end para la salida:
    ...
    | Tipo de IP | Seleccione **Dirección IP** o **Prefijo IP**.|
    | Dirección IP pública | Seleccione **Crear nuevo**. </br> En **Agregar una dirección IP pública**, escriba **myPublicIPOutbound**. </br> Si usa el prefijo IP, en **Agregar un prefijo de dirección IP pública**, escriba **myPublicIPPrefixOutbound**. Elija un **tamaño de prefijo** para el prefijo de IP pública. </br> Seleccione **Aceptar**.  |
