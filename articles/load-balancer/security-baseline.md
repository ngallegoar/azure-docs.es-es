...
*Para obtener más información, consulte [Azure Security Benchmark: Seguridad de redes](https://docs.microsoft.com/azure/security/benchmarks/security-control-network-security).*
