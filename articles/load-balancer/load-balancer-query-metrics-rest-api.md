...
Utilice la siguiente solicitud GET para recopilar la [métrica de ByteCount](/azure/load-balancer/load-balancer-standard-diagnostics#multi-dimensional-metrics) desde un servicio Standard Load Balancer. 
