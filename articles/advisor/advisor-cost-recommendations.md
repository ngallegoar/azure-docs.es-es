...
### <a name="azure-synapse-analytics-formerly-sql-data-warehouse-reserved-capacity"></a>Capacidad reservada de Azure Synapse Analytics (anteriormente, SQL Data Warehouse)
