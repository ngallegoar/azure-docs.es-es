...
![Ejemplo de un objeto de texto de varias líneas en la capa de etiquetas](./media/drawing-conversion-error-codes/multiline.png)
...
![Ejemplo de penetración vertical 2](./media/drawing-conversion-error-codes/vrt.png)
