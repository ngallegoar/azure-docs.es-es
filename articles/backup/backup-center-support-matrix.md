...
| Acciones | Crear almacén | <li> Máquina virtual de Azure <br><br> <li> Servidor de Azure Database for PostgreSQL | Consulte las matrices de compatibilidad para el [almacén de Recovery Services](./backup-support-matrix.md#vault-support) |
| Acciones | Creación de una directiva de copia de seguridad | <li> Máquina virtual de Azure <br><br> <li> Servidor de Azure Database for PostgreSQL | Consulte las matrices de compatibilidad para el [almacén de Recovery Services](./backup-support-matrix.md#vault-support) |
