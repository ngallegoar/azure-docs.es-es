...
1. Instale los módulos más recientes de Az de Azure PowerShell en [este vínculo](https://docs.microsoft.com//powershell/azure/install-az-ps?view=azps-3.3.0) antes de ejecutar el script.
