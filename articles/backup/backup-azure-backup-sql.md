...
>La protección de la [instancia de clúster de conmutación por error de SQL Server con Espacios de almacenamiento directo en Azure](https://docs.microsoft.com/azure/azure-sql/virtual-machines/windows/failover-cluster-instance-storage-spaces-direct-manually-configure) y la [instancia de clúster de conmutación por error de SQL Server con los discos compartidos de Azure](https://docs.microsoft.com/azure/azure-sql/virtual-machines/windows/failover-cluster-instance-azure-shared-disks-manually-configure) es compatible con esta característica. El servidor DPM se debe implementar en la máquina virtual de Azure para proteger la instancia de clúster de conmutación por error de SQL implementada en las máquinas virtuales de Azure. 
