...
En la [documentación de referencia de SDK de HDInsight para .-NET](/dotnet/api/overview/azure/hdinsight&preserve-view=true) puede encontrar fragmentos de código para esta funcionalidad adicional de SDK.
