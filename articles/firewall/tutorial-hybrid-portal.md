...
2. Seleccione **Siguiente: Direcciones IP** .
3. En **Espacio de direcciones IPv4** , escriba **10.5.0.0/16** .
6. En **Nombre de subred** , seleccione **predeterminada** .
7. En **Nombre** , escriba **AzureFirewallSubnet** . El firewall estará en esta subred y el nombre de la subred **debe** ser AzureFirewallSubnet.
8. En **Intervalo de direcciones** , escriba **10.5.0.0/26** . 
...
4. En **Espacio de direcciones IPv4** , escriba **10.6.0.0/16** .
6. En **Nombre de subred** , seleccione **predeterminada** .
7. En **Nombre** , escriba **SN-Workload** .
8. En **Intervalo de direcciones** , escriba **10.6.0.0/24** . 
9. Seleccione **Guardar** .
10. Seleccione **Revisar + crear** .
11. Seleccione **Crear** .
...
2. En **Región** , seleccione **(EE. UU.) Este de EE. UU.** .
3. Seleccione **Siguiente: Direcciones IP**
4. En **Espacio de direcciones IPv4** , escriba **192.168.0.0/16** .
5. En **Nombre de subred** , seleccione **predeterminada** .
7. En **Nombre** , escriba **SN-Corp** .
8. En **Intervalo de direcciones** , escriba **192.168.1.0/24** . 
9. Seleccione **Guardar** .
10. Seleccione **Revisar + crear** .
11. Seleccione **Crear** .
