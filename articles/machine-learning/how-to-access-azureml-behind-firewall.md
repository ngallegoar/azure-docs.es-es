...
| **\*.file.core.windows.net** | Lo necesita el explorador de archivos en Estudio de Azure Machine Learning. |
| **\*.dfs.core.windows.net** | Lo necesita el explorador de archivos en Estudio de Azure Machine Learning. |
