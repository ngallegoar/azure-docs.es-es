...
| 6 | [Mantenimiento predictivo de Azure IoT](https://github.com/Azure/azure-iot-predictive-maintenance) | PCS de Azure IoT Suite: solución preconfigurada. Plantilla de mantenimiento predictivo para el mantenimiento aeronáutico con IoT Suite. [Otro documento](../../iot-accelerators/quickstart-predictive-maintenance-deploy.md) y [tutorial](../../iot-accelerators/iot-accelerators-predictive-walkthrough.md) relacionados con el mismo proyecto. |
