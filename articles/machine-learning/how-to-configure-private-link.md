...
En este documento, aprenderá a usar Azure Private Link con el área de trabajo de Azure Machine Learning. Esta funcionalidad está actualmente en versión preliminar y está disponible en las regiones Este de EE. UU., Oeste de EE. UU. 2 y Centro y Sur de EE. UU. 
...
Actualmente, solo se admite la habilitación de un punto de conexión privado al crear una nueva área de trabajo de Azure Machine Learning. Se proporcionan las siguientes plantillas para varias configuraciones conocidas:

> [!TIP]
> La aprobación automática controla el acceso automatizado al recurso habilitado para Private Link. Para más información, consulte [¿Qué es el servicio Azure Private Link?](../private-link/private-link-service-overview.md)

* [Área de trabajo con claves administradas por el cliente y aprobación automática para Private Link](#cmkaapl)
* [Área de trabajo con claves administradas por el cliente y aprobación manual para Private Link](#cmkmapl)
* [Área de trabajo con claves administradas por Microsoft y aprobación automática para Private Link](#mmkaapl)
* [Área de trabajo con claves administradas por Microsoft y aprobación manual para Private Link](#mmkmapl)

Al implementar una plantilla, debe proporcionar la información siguiente:

* Nombre del área de trabajo
* Región de Azure en la que crear los recursos
* Edición del área de trabajo (Básico o Enterprise)
* Si se debe habilitar la configuración de alta confidencialidad para el área de trabajo
* Si se debe habilitar el cifrado del área de trabajo con una clave administrada por el cliente y los valores asociados para la clave
* Nombre de red virtual y de subred, la plantilla creará una red virtual y una subred nuevas

Una vez que se ha enviado una plantilla y se ha completado el aprovisionamiento, el grupo de recursos que contiene el área de trabajo contendrá tres nuevos tipos de artefactos relacionados con Private Link:

* Punto de conexión privado
* interfaz de red
* Zona DNS privada

El área de trabajo también contiene una red virtual de Azure que se puede comunicar con el área de trabajo mediante el punto de conexión privado.

### <a name="deploy-the-template-using-the-azure-portal"></a>Implementación de la plantilla con Azure Portal

1. Siga los pasos que se indican en [Implementación de recursos desde plantilla personalizada](https://docs.microsoft.com/azure/azure-resource-manager/resource-group-template-deploy-portal#deploy-resources-from-custom-template). Cuando llegue a la pantalla __Editar plantilla__, pegue una de las plantillas del final de este documento.
...
### <a name="deploy-the-template-using-azure-powershell"></a>Implementación de la plantilla con Azure PowerShell

En este ejemplo se da por supuesto que ha guardado una de las plantillas del final de este documento en un archivo llamado `azuredeploy.json` en el directorio actual:
...
### <a name="deploy-the-template-using-the-azure-cli"></a>Implementación de la plantilla con la CLI de Azure
...
Para obtener información sobre cómo colocar la instancia de Key Vault en la red virtual, consulte [Uso de una instancia de Key Vault con el área de trabajo](how-to-enable-virtual-network.md#use-a-key-vault-instance-with-your-workspace).
...
> [!WARNING]
> Azure Machine Learning no admite el uso de una instancia de Azure Kubernetes Service que tenga habilitado Private Link.

## <a name="azure-container-registry"></a>Azure Container Registry

Para obtener información sobre cómo proteger Azure Container Registry dentro de la red virtual, consulte [Uso de Azure Container Registry](how-to-enable-virtual-network.md#use-azure-container-registry).
...
<a id="cmkaapl"></a>
### <a name="workspace-with-customer-managed-keys-and-auto-approval-for-private-link"></a>Área de trabajo con claves administradas por el cliente y aprobación automática para Private Link
...
<a id="cmkmapl"></a>
### <a name="workspace-with-customer-managed-keys-and-manual-approval-for-private-link"></a>Área de trabajo con claves administradas por el cliente y aprobación manual para Private Link
...
<a id="mmkaapl"></a>
### <a name="workspace-with-microsoft-managed-keys-and-auto-approval-for-private-link"></a>Área de trabajo con claves administradas por Microsoft y aprobación automática para Private Link
...
<a id="mmkmapl"></a>
### <a name="workspace-with-microsoft-managed-keys-and-manual-approval-for-private-link"></a>Área de trabajo con claves administradas por Microsoft y aprobación manual para Private Link
