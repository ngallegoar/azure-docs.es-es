...
1. Abra el subdirectorio `samples-*` y, después, abra `how-to-use-azureml/deployment/deploy-to-local/register-model-deploy-local.ipynb`. Una vez abiertos, ejecute el cuaderno.
