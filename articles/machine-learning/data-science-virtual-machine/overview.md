...
description: 'Información general de Azure Data Science Virtual Machine: una máquina virtual fácil de crear y usar en la plataforma de nube de Azure, con herramientas y bibliotecas preinstaladas y configuradas para la práctica de la ciencia de datos y el desarrollo de aplicaciones inteligentes.'
...
Las ediciones de Windows de DSVM vienen preinstaladas con controladores de GPU, marcos y versiones de GPU de los marcos de aprendizaje profundo. En la edición de Linux, el aprendizaje profundo en las GPU está habilitado en las DSVM de Ubuntu. 
