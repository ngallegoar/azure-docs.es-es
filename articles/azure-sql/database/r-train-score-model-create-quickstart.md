...
![Modelo entrenado con salida adicional](./media/r-train-score-model-create-quickstart/r-train-model-with-additional-output.png)
...
2. Prediga la distancia de frenado a partir de estos nuevos valores de velocidad.
   ...
   **Resultados**
   ...
   ![Resultado establecido para predecir la distancia de frenado](./media/r-train-score-model-create-quickstart/r-predict-stopping-distance-resultset.png)
