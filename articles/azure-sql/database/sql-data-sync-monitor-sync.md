...
description: Aprenda a supervisar SQL Data Sync con registros de Azure Monitor.
...
![Notificaciones de correo electrónico de Data Sync](./media/sql-data-sync-monitor-sync/sync-email-notifications.png)
...
-   [Información general de SQL Database](../../sql-database/sql-database-technical-overview.md)
