...
Obtenga más información sobre los [mensajes de error de SQL](https://docs.microsoft.com/sql/relational-databases/errors-events/database-engine-events-and-errors).
