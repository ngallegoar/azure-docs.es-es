...
description: Azure SQL Database permite equilibrar las cargas de trabajo de solo lectura mediante una funcionalidad de réplicas de solo lectura denominada "Escalado horizontal de lectura".
