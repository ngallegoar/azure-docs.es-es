...
En este artículo se describen algunos de los problemas comunes que se pueden producir al mover datos entre R y SQL Database en [Machine Learning Services (con R) en Azure SQL Database](machine-learning-services-overview.md). La experiencia que se obtiene en este ejercicio proporciona información básica sobre el uso de datos en su propio script.
