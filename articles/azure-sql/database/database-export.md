---
title: Exportación de una base de datos de Azure SQL a un archivo BACPAC (Azure Portal)
...
ms.locfileid: "84188844"
---
# <a name="export-to-a-bacpac-file---azure-sql-database--sql-managed-instance"></a>Exportación a un archivo BACPAC: Azure SQL Database e Instancia administrada de SQL
...
Actualmente, no se admite la exportación de una base de datos desde una [instancia administrada de Azure SQL](../managed-instance/sql-managed-instance-paas-overview.md) mediante Azure Portal. Use SQL Server Management Studio o SQLPackage en su lugar.
...
Las versiones más recientes de SQL Server Management Studio proporcionan un asistente para exportar una base de datos de Azure SQL Database o de Instancia administrada de SQL a un archivo BACPAC. Consulte [Export a Data-tier Application](https://docs.microsoft.com/sql/relational-databases/data-tier-applications/export-a-data-tier-application) (Exportación de una aplicación de la capa de datos).
