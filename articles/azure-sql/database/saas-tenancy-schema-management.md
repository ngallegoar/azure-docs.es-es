...
A continuación, pruebe el [tutorial de notificaciones ad hoc](../../sql-database/saas-tenancy-cross-tenant-reporting.md) para explorar la ejecución de consultas distribuidas en las bases de datos de inquilino.


## <a name="additional-resources"></a>Recursos adicionales

* [Otros tutoriales basados en la implementación de la aplicación Wingtip Tickets SaaS Database Per Tenant](../../sql-database/saas-dbpertenant-wingtip-app-overview.md#sql-database-wingtip-saas-tutorials)
