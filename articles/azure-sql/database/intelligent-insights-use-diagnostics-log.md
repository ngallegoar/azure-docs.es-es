...
- Aprenda a [supervisar problemas de rendimiento mediante Azure SQL Analytics](https://docs.microsoft.com/azure/log-analytics/log-analytics-azure-sql).
