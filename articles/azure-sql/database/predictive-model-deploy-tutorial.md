...
En la [segunda parte](predictive-model-build-compare-tutorial.md), aprendió a crear y entrenar varios modelos de Machine Learning en R y, luego, elegir el más preciso.

## <a name="prerequisites"></a>Requisitos previos

* En la tercera parte de esta serie de tutoriales se da por hecho que ha completado [**la primera parte**](predictive-model-prepare-data-tutorial.md) y la [**segunda parte**](predictive-model-build-compare-tutorial.md).
