...
- Una [base de datos de Azure SQL Database](single-database-create-quickstart.md) con una [regla de firewall de nivel de servidor](firewall-create-server-level-portal-quickstart.md)
...
1. Use la instrucción `SELECT` para consultar la tabla.
    ...
    **Resultados**
    ...
    ![Contenido de la tabla RTestData](./media/r-script-create-quickstart/select-rtestdata.png)
...
1. Ejecute el siguiente script de R. Recupera los datos de la tabla mediante la instrucción `SELECT`, los pasa mediante el entorno de ejecución de R y devuelve los datos como una trama de datos. La cláusula `WITH RESULT SETS` define el esquema de la tabla de datos devuelta para SQL Database y agrega el nombre de columna *NewColName*.
    ...
    **Resultados**
    ...
    ![Salida del script de R que devuelve datos de una tabla](./media/r-script-create-quickstart/r-output-rtestdata.png)
...
1. También puede generar valores con el script de R sin datos de entrada (`@input_data_1` se establece en blanco).
    ...
    **Resultados**
    ...
    ![Resultados de consultas con @script como entrada](./media/r-script-create-quickstart/r-data-generated-output.png)
...
![Paquetes instalados en R](./media/r-script-create-quickstart/r-installed-packages.png)
...
> [Crear y entrenar un modelo predictivo en R con Machine Learning Services (versión preliminar) de Azure SQL Database](r-train-score-model-create-quickstart.md)
...
- [Azure SQL Database Machine Learning Services con R (versión preliminar)](machine-learning-services-overview.md)
