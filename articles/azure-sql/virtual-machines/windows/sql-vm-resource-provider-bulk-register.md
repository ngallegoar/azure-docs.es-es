...
Para más información sobre el proveedor de recursos, vea [Registro de una máquina virtual con SQL Server en Azure con el proveedor de recursos de máquina virtual con SQL](sql-vm-resource-provider-register.md). 
...
## <a name="resister-all-vms-in-a-resource-group"></a>Registro de todas las máquinas virtuales de un grupo de recursos
...
## <a name="register-specific-vms-in-single-resource-group"></a>Registro de máquinas virtuales específicas de un solo grupo de recursos
