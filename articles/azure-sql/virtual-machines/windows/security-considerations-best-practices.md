...
Si también está interesado en los procedimientos recomendados de rendimiento, consulte [Procedimientos recomendados para SQL Server en Azure Virtual Machines](performance-guidelines-best-practices.md).
