...
Los discos administrados ofrecen cifrado del lado servidor y Azure Disk Encryption. El [cifrado del lado servidor](/azure/virtual-machines/windows/disk-encryption) proporciona cifrado en reposo y protege los datos con el fin de cumplir con los compromisos de cumplimiento y seguridad de su organización. [Azure Disk Encryption](/azure/security/fundamentals/azure-disk-encryption-vms-vmss) usa la tecnología BitLocker o DM-Crypt y se integra con Azure Key Vault para cifrar los discos de datos y del sistema operativo. 
