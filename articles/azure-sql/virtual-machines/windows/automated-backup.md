...
> [!IMPORTANT]
> Automated Backup v2 funciona con SQL Server 2016 o posterior. Si usa SQL Server 2014, puede usar Automated Backup v1 para hacer copias de seguridad de las bases de datos. Para obtener más información, vea [Automated Backup para SQL Server 2014 en Azure Virtual Machines](automated-backup-sql-2014.md).
...
- Las bases de datos del sistema no tienen que usar el modelo de recuperación completa. Aun así, sí debe usar el modelo de recuperación completa si necesita realizar copias de seguridad de registros para el modelo o para MSDB.
- Las bases de datos de destino deben estar en la instancia predeterminada de SQL Server o en una instancia con nombre [instalada correctamente](frequently-asked-questions-faq.md#administration). 
