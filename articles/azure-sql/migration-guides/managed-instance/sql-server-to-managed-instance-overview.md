...
|[Asistente de importación y exportación/BACPAC](/azure/azure-sql/database/database-import?tabs=azure-powershell)| [BACPAC](/sql/relational-databases/data-tier-applications/data-tier-applications#bacpac) es un archivo de Windows con una extensión `.bacpac` que encapsula el esquema y los datos de una base de datos. El archivo BACPAC se puede usar para exportar datos de una instancia de SQL Server de origen y para volver a importar el archivo a Azure SQL Managed Instance.  |  
|[Azure Data Factory (ADF)](/azure/data-factory/connector-azure-sql-managed-instance)| La [actividad de copia](/azure/data-factory/copy-activity-overview) de Azure Data Factory migra los datos de las bases de datos de SQL Server de origen a SQL Managed Instance mediante conectores integrados y una instancia de [Integration Runtime](/azure/data-factory/concepts-integration-runtime).</br> </br> ADF admite una amplia gama de [conectores](/azure/data-factory/connector-overview) para trasladar datos de orígenes de SQL Server a SQL Managed Instance. |
| | |
...
|---------|---------|---------|
|[Azure Database Migration Service (DMS)](/azure/dms/tutorial-sql-server-to-managed-instance) | - Migración de bases de datos únicas o de varias bases de datos a escala. </br> - Puede admitir tiempo de inactividad durante el proceso de migración. </br> </br> Orígenes compatibles: </br> - SQL Server (2005 - 2019) local o VM de Azure </br> - AWS EC2 </br> - AWS RDS </br> - VM con SQL Server de GCP Compute |  - Las migraciones a escala se pueden automatizar a través de [PowerShell](/azure/dms/howto-sql-server-to-azure-sql-mi-powershell). </br> - El tiempo para completar la migración depende del tamaño de la base de datos y se ve afectado por el tiempo de la copia de seguridad y la restauración. </br> - Es posible que se requiera tiempo de inactividad suficiente. |
...
Migre paquetes y proyectos de SQL Server Integration Services (SSIS) de SSISDB a Azure SQL Managed Instance mediante [Azure Database Migration Service (DMS)](/azure/dms/how-to-migrate-ssis-packages-managed-instance). 
...
También puede considerar la posibilidad de migrar los modelos tabulares de Analysis Services locales a [Power BI Premium con los nuevos puntos de conexión de lectura y escritura XMLA](https://docs.microsoft.com/power-bi/admin/service-premium-connect-tools). 
> [!NOTE]
...
Use la opción Azure Database Migration Service (DMS) sin conexión para migrar [trabajos del Agente SQL](/azure/dms/howto-sql-server-to-azure-sql-mi-powershell#offline-migrations). En caso contrario, cree un script de los trabajos en Transact-SQL (T-SQL) mediante SQL Server Management Studio y, a continuación, vuelva a crearlos manualmente en la instancia de SQL Managed Instance de destino. 
