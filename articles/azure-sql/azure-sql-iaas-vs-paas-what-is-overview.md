...
- Solucionar posibles amenazas en tiempo real con [detección de amenazas avanzada](../security/fundamentals/threat-detection.md#advanced-threat-detection-features-other-azure-services) inteligente y alertas proactivas de evaluación de vulnerabilidades. 
