...
>
> Para continuar utilizando la autenticación de Azure Active Directory con MFA, necesitará [SSMS 18.6 o versiones posteriores](https://docs.microsoft.com/sql/ssms/download-sql-server-management-studio-ssms).
