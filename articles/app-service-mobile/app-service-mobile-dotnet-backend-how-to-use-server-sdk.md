---
title: Trabajo con el SDK del servidor back-end de .NET
...
La documentación de referencia para el SDK de servidor se encuentra aquí: [Referencia de .NET para Azure Mobile Apps][1].

## <a name="how-to-create-a-net-mobile-app-backend"></a><a name="create-app"></a>Procedimientos: Creación de un back-end de aplicación móvil .NET
...
### <a name="create-a-net-backend-using-visual-studio-2017"></a>Creación de un back-end de .NET con Visual Studio 2017
...
7. Haga clic con el botón derecho en el proyecto en el **Explorador de soluciones** y elija **Publicar...**  y luego **App Service** como destino de publicación.
8. Siga las indicaciones para autenticar y elija un servicio de aplicaciones de Azure nuevo o existente para publicar.
...
## <a name="how-to-download-and-initialize-the-sdk"></a><a name="install-sdk"></a>Procedimientos: Descarga e inicialización del SDK
...
### <a name="initialize-the-server-project"></a><a name="server-project-setup"></a> Inicializar el proyecto de servidor
...
* [Microsoft.Azure.Mobile.Server.Home](https://www.nuget.org/packages/Microsoft.Azure.Mobile.Server.Home/) Implementa el valor predeterminado de *esta página de aplicación móvil está funcionando* para la raíz del sitio web. Se agrega a la configuración mediante una llamada al método de extensión **AddMobileAppHomeController** .
* [Microsoft.Azure.Mobile.Server.Tables](https://www.nuget.org/packages/Microsoft.Azure.Mobile.Server.Tables/) incluye clases para trabajar con datos y configura la canalización de datos. Se agrega a la configuración mediante una llamada al método de extensión **AddTables** .
* [Microsoft.Azure.Mobile.Server.Entity](https://www.nuget.org/packages/Microsoft.Azure.Mobile.Server.Entity/) permite a Entity Framework obtener acceso a los datos de SQL Database. Se agrega a la configuración mediante una llamada al método de extensión **AddTablesWithEntityFramework** .
...
* [Microsoft.Azure.Mobile.Server.CrossDomain](https://www.nuget.org/packages/Microsoft.Azure.Mobile.Server.CrossDomain/) crea un controlador que sirve datos de la aplicación móvil a los exploradores web heredados. Se agrega a la configuración mediante una llamada al método de extensión **MapLegacyCrossDomainController** .
...
## <a name="how-to-publish-the-server-project"></a><a name="publish-server-project"></a>Procedimientos: Publicación del proyecto de servidor
...
## <a name="how-to-define-a-table-controller"></a><a name="define-table-controller"></a> Procedimientos para: Definición de un controlador de tabla
...
### <a name="how-to-adjust-the-table-paging-size"></a><a name="adjust-pagesize"></a>Procedimientos: Cómo ajustar el tamaño de paginación de la tabla
...
## <a name="how-to-define-a-custom-api-controller"></a>Procedimientos: Cómo definir un controlador de API personalizada
...
## <a name="how-to-work-with-authentication"></a>Procedimientos: Trabajar con la autenticación
...
* [Cómo: Cómo agregar autenticación a un proyecto de servidor](#add-auth)
* [Cómo: Uso de la autenticación personalizada en una aplicación](#custom-auth)
* [Cómo: Recuperación de la información de usuario autenticado](#user-info)
* [Cómo: Cómo restringir el acceso a datos para los usuarios autorizados](#authorize)

### <a name="how-to-add-authentication-to-a-server-project"></a><a name="add-auth"></a>Procedimientos: Cómo agregar autenticación a un proyecto de servidor
...
### <a name="how-to-use-custom-authentication-for-your-application"></a><a name="custom-auth"></a>Procedimientos: Uso de la autenticación personalizada en una aplicación
> [!IMPORTANT]
...
### <a name="how-to-retrieve-authenticated-user-information"></a><a name="user-info"></a>Procedimientos: Recuperación de la información de usuario autenticado
...
### <a name="how-to-restrict-data-access-for-authorized-users"></a><a name="authorize"></a>Procedimientos: Cómo restringir el acceso a datos para los usuarios autorizados
...
## <a name="how-to-add-push-notifications-to-a-server-project"></a>Procedimientos: Cómo agregar notificaciones push a un proyecto de servidor
...
## <a name="how-to-enable-targeted-push-using-tags"></a><a name="tags"></a>Procedimientos: Habilitación de la inserción de destino mediante etiquetas
...
## <a name="how-to-send-push-notifications-to-an-authenticated-user"></a><a name="push-user"></a>Procedimientos: Envío de notificaciones push a un usuario autenticado
...
### <a name="local-debugging-with-authentication"></a><a name="local-debug"></a>Depuración local con autenticación
