...
### <a name="how-to-install-the-managed-client-sdk-package"></a>Procedimientos: Instalación del paquete del SDK de cliente administrado
...
* **Xamarin Studio** Haga clic con el botón derecho en el proyecto, haga clic en **Add**>**Add NuGet Packages** (Agregar > Agregar paquetes NuGet), busque el paquete `Microsoft.Azure.Mobile.Client` y haga clic en **Add Package** (Agregar paquete).
...
## <a name="create-the-mobile-apps-client"></a><a name="create-client"></a>Creación del cliente de Mobile Apps
...
### <a name="how-to-create-a-table-reference"></a><a name="instantiating"></a>Procedimientos: Creación de una referencia de tabla
...
### <a name="how-to-query-data-from-your-mobile-app"></a><a name="querying"></a>Procedimientos: Consulta de datos desde la aplicación móvil
...
### <a name="how-to-filter-returned-data"></a><a name="filtering"></a>Procedimientos: Filtro de datos devueltos
...
### <a name="how-to-sort-returned-data"></a><a name="sorting"></a>Procedimientos: Ordenar datos devueltos
...
### <a name="how-to-return-data-in-pages"></a><a name="paging"></a>Procedimientos: Devolver datos en páginas
...
### <a name="how-to-select-specific-columns"></a><a name="selecting"></a>Procedimientos: Selección de columnas específicas
...
### <a name="how-to-look-up-data-by-id"></a><a name="lookingup"></a>Procedimientos: Buscar datos por identificador
...
### <a name="how-to-execute-untyped-queries"></a><a name="untypedqueries"></a>Procedimientos: Ejecución de consultas sin tipo
...
### <a name="how-to-insert-data-into-a-mobile-app-backend"></a><a name="inserting"></a>Procedimientos: Inserción de datos en el back-end de una aplicación móvil
...
### <a name="how-to-modify-data-in-a-mobile-app-backend"></a><a name="modifying"></a>Procedimientos: Modificación de datos en el back-end de una aplicación móvil
...
### <a name="how-to-delete-data-in-a-mobile-app-backend"></a><a name="deleting"></a>Procedimientos: Eliminación de datos del back-end de una aplicación móvil
...
### <a name="how-to-use-optimistic-concurrency-for-conflict-resolution"></a><a name="optimisticconcurrency"></a>Procedimientos: Uso de la simultaneidad optimista para resolver conflictos
...
### <a name="how-to-bind-mobile-apps-data-to-a-windows-user-interface"></a><a name="binding"></a>Procedimientos: Enlace de datos de Mobile Apps a una interfaz de usuario de Windows
...
### <a name="change-the-page-size"></a><a name="pagesize"></a>Cambio del tamaño de página
...
## <a name="work-with-offline-tables"></a><a name="#offlinesync"></a>Trabajo con tablas sin conexión
...
### <a name="syncing-an-offline-table"></a><a name="syncoffline"></a>Sincronización de una tabla sin conexión
...
## <a name="work-with-a-custom-api"></a><a name="#customapi"></a>Trabajo con una API personalizada
...
## <a name="authenticate-users"></a><a name="authentication"></a>Autenticación de usuarios
...
### <a name="client-managed-authentication"></a><a name="clientflow"></a>Autenticación administrada por el cliente
...
#### <a name="authenticate-users-with-the-active-directory-authentication-library"></a><a name="adal"></a>Autenticación de usuarios con la biblioteca de autenticación de Active Directory
...
#### <a name="single-sign-on-using-a-token-from-facebook-or-google"></a><a name="client-facebook"></a>Inicio de sesión único mediante un token de Facebook o Google
...
### <a name="server-managed-authentication"></a><a name="serverflow"></a>Autenticación administrada por el servidor
...
### <a name="caching-the-authentication-token"></a><a name="caching"></a>Almacenamiento en caché del token de autenticación
...
## <a name="push-notifications"></a><a name="pushnotifications"></a>Notificaciones push
...
### <a name="how-to-obtain-a-microsoft-store-package-sid"></a><a name="package-sid"></a>Procedimientos: Obtención del SID de un paquete de Microsoft Store
...
### <a name="how-to-register-push-templates-to-send-cross-platform-notifications"></a><a name="register-xplat"></a>Procedimientos: Registro de plantillas push para enviar notificaciones entre plataformas
...
## <a name="miscellaneous-topics"></a><a name="misc"></a>Temas variados
### <a name="how-to-handle-errors"></a><a name="errors"></a>Procedimientos: errores
...
### <a name="how-to-customize-request-headers"></a><a name="headers"></a>Procedimientos: Personalización de encabezados de solicitud
...
[Agregar notificaciones push a la aplicación]: app-service-mobile-windows-store-dotnet-get-started-push.md
[Register your app to use a Microsoft account login]: ../app-service/configure-authentication-provider-microsoft.md
[Configuración de App Service para usar el inicio de sesión de Azure Active Directory]: ../app-service/configure-authentication-provider-aad.md
...
[Centro de desarrollo de Windows]: https://dev.windows.com/overview
...
<!-- External URLs -->
[documentación de OData v3]: https://www.odata.org/documentation/odata-version-3-0/
