---
title: Introducción a la autenticación en la aplicación de Xamarin Forms
description: Aprenda a usar Mobile Apps para autenticar usuarios de la aplicación de Xamarin Forms con proveedores de identidad como AAD, Google, Facebook, Twitter y Microsoft.
...
1. En [Azure Portal][8], seleccione el servicio App Service.
...
5. Actualice la clase **MainActivity**, para lo que debe agregar un campo **MobileServiceUser** y un método **Authenticate**, lo que necesita la interfaz **IAuthenticate**, como se indica a continuación:
    ...
    Si usa un proveedor de identidades que no sea Facebook, elija un valor diferente para [MobileServiceAuthenticationProvider][7].
