---
title: Introducción a la autenticación en Xamarin iOS
description: Aprenda a usar Mobile Apps para autenticar usuarios de la aplicación de Xamarin iOS con proveedores de identidad como AAD, Google, Facebook, Twitter y Microsoft.
