...
Un registro CNAME asigna un dominio a otro. Puede usar un registro CNAME para asignar `www.example.com` al dominio generado automáticamente que proporciona Azure Static Web Apps.
