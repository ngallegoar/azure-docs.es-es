...
![Texto de salida después de iniciar el movimiento del grupo de recursos de origen](./media/move-region-powershell/initiate-move-resource-group.png)
