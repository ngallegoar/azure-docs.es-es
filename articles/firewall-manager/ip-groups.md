...
Un grupo de IP se puede crear mediante Azure Portal, la CLI de Azure o la API REST. Para más información, consulte [Creación de grupos de IP](../firewall/create-ip-group.md).
