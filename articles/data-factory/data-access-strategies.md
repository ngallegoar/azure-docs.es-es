...
> [!NOTE] 
> Los intervalos de direcciones IP están bloqueados para el entorno de ejecución de integración de Azure y actualmente solo se usan para movimiento de datos, canalización y actividades externas. Ahora, los flujos de entrada no usan estos intervalos IP. 
...
* **Azure Integration Runtime**
    ...
    | Almacenes de datos                  | Mecanismo de seguridad de red compatible con almacenes de datos         | Servicio de confianza     | Rango de direcciones IP estáticas | Etiquetas de servicio | Permitir servicios de Azure |
    |------------------------------|-------------------------------------------------------------|---------------------|-----------------|--------------|----------------------|
    | Almacenes de datos PaaS de Azure       | Azure Cosmos DB                                             | -                   | Sí             | -            | Sí                  |
    ...
    |                              | Azure Storage (blog, ADLS Gen2)                             | Sí (solo autenticación MSI) | Sí             | -            | .                    |
    |                              | Base de datos de Azure SQL, SQL DW (Synapse Analytics), SQL Ml          | -                   | Sí             | -            | Sí                  |
