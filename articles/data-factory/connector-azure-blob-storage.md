...
| prefix                   | Prefijo para el nombre de blob en el contenedor dado configurado en el conjunto de datos para filtrar los blobs de origen. Se seleccionan blobs cuyo nombre comienza con este prefijo. <br>Solo se aplica cuando no se especifican las propiedades `wildcardFolderPath` y `wildcardFileName`. | No                                                          |
