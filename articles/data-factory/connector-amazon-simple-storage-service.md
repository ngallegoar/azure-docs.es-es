...
| OPCIÓN 2: Prefijo S3<br>- prefix | Prefijo del nombre de la clave de S3 en el cubo especificado configurado en el conjunto de datos para filtrar archivos de S3 de origen. Se seleccionan claves de S3 cuyo nombre comienza con `bucket_in_dataset/this_prefix`. Emplea el filtro del servicio de S3, que proporciona un mejor rendimiento que el filtro de caracteres comodín. | No |
...
| OPCIÓN 3: lista de archivos<br>- fileListPath | Indica que se copie un conjunto de archivos determinado. Apunte a un archivo de texto que incluya una lista de archivos que quiera copiar, un archivo por línea que constituye la ruta de acceso relativa a la ruta de acceso configurada en el conjunto de datos.<br/>Al usar esta opción, no especifique el nombre de archivo en el conjunto de datos. Puede ver más ejemplos en [Ejemplos de lista de archivos](#file-list-examples). |No |
...
Al copiar archivos de Amazon S3 en Azure Data Lake Storage Gen2/Azure Blob, puede optar por conservar los metadatos de archivo junto con los datos. Más información en [Conservación de metadatos](copy-activity-preserve-metadata.md#preserve-metadata).
