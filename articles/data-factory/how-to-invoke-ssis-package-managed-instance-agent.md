...
Para usar esta característica, [descargue](/sql/ssms/download-sql-server-management-studio-ssms?view=sql-server-2017) e instale la versión más reciente de SQL Server Management Studio (SSMS). A continuación encontrará los detalles de la compatibilidad de versiones:
