...
|[Copia masiva](scripts/bulk-copy-powershell.md?toc=%2fpowershell%2fmodule%2ftoc.json)| En este script de ejemplo de PowerShell, se copian datos de varias tablas de una base de datos de Azure SQL Database en Azure Synapse Analytics (anteriormente, SQL Data Warehouse). |
