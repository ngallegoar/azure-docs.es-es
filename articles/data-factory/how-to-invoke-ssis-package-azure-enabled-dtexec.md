...
Para usar AzureDTExec, descargue e instale la versión más reciente de SSMS, que es la versión 18.3 o posterior. Descárguelo de [este sitio web](/sql/ssms/download-sql-server-management-studio-ssms?view=sql-server-2017).
...
La invocación de AzureDTExec ofrece opciones similares al invocar dtexec. Para obtener más información, consulte [utilidad dtexec](/sql/integration-services/packages/dtexec-utility?view=sql-server-2017). Estas son las opciones que se admiten actualmente:
