...
Para ver todos los conjuntos de datos disponibles, vaya al [catálogo de conjuntos de datos de Open Datasets de Azure](https://azure.microsoft.com/services/open-datasets/catalog/).
...
* [Tutorial: Regression modeling with NY taxi data](../machine-learning/tutorial-auto-train-models.md?context=azure%252fopen-datasets%252fcontext%252fopen-datasets-context) (Tutorial: Modelado de regresión con datos de taxis de Nueva York)
* [SDK de Python para Open Datasets](/python/api/azureml-opendatasets/)
