...
También se pueden crear conjuntos de datos de Open Datasets con [Azure Machine Learning Studio](https://ml.azure.com). En el área de trabajo, seleccione la pestaña **Conjunto de datos** en **Recursos**. En el menú desplegable **Crear conjunto de datos**, seleccione **From Open Datasets** (Desde Open Datasets).
