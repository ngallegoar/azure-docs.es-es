...
* [Propiedad RemoteManager.OutlineSettings de C#](/dotnet/api/microsoft.azure.remoterendering.remotemanager.outlinesettings)
* [RemoteManager::OutlineSettings() de C++](/cpp/api/remote-rendering/remotemanager#outlinesettings)
