...
* [Propiedad RemoteManager.OutlineSettings de C#](https://docs.microsoft.com/dotnet/api/microsoft.azure.remoterendering.remotemanager.outlinesettings)
* [RemoteManager::OutlineSettings() de C++](https://docs.microsoft.com/cpp/api/remote-rendering/remotemanager#outlinesettings)
