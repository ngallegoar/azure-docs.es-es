...
1. Compruebe que el proyecto tiene la estructura siguiente.
    ...
    ![Estructura de directorios del proyecto, más las clases](media/search-get-started-java/java-quickstart-basic-code-tree-plus-classes.png)
