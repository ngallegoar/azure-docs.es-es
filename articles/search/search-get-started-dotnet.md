---
title: Creación de un índice de búsqueda en .NET
...
1. Busque `Microsoft.Azure.Search` y seleccione la versión 9.0.1 o posterior (la versión estable más reciente es la 10.1.0).
