...
> [!Important]
> Las reglas de IP en el servicio de Azure Cognitive Search se pueden configurar con Azure Portal o la [API REST de administración, versión 2020-03-13](https://docs.microsoft.com/rest/api/searchmanagement/).
