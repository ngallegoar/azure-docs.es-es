...
- Los [puntos de conexión de servicio](../virtual-network/virtual-network-service-endpoints-overview.md) no se admitirán en ningún recurso de Azure.
...
- [SQL Server en máquinas virtuales IaaS](./search-howto-connecting-azure-sql-iaas-to-azure-search-using-indexers.md#restrict-access-to-the-azure-cognitive-search)
...
Se espera entonces que el cliente encuentre esta solicitud en su recurso seguro y la apruebe. Normalmente, esta operación se puede hacer a través del portal o la [API REST](/rest/api/virtualnetwork/privatelinkservices/updateprivateendpointconnection).
