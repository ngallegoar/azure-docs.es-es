...
:::image type="content" source="media/search-get-started-nodejs/create-index-no-data.png" alt-text="Obtención del nombre del servicio y las claves de consulta y administrador" border="false":::
