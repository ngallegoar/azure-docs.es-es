...
##  <a name="boolean-operators-and-or-not"></a><a name="bkmk_boolean"></a> Operadores booleanos (AND, OR, NOT) 
...
##  <a name="query-size-limitations"></a><a name="bkmk_querysizelimits"></a> Límites de tamaño de consulta  
