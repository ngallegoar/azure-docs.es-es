...
- [Configuración de claves administradas por el cliente para el cifrado de datos mediante una identidad administrada](./search-security-manage-encryption-keys.md#3---create-a-service-identity)
