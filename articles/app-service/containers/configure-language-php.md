...
> [!NOTE]
> La mejor forma de ver la versión de PHP y la configuración de *php.ini* actual consiste en llamar a [phpinfo()](https://www.php.net/manual/function.phpinfo.php) en la aplicación.
>
