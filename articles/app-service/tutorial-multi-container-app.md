...
En Cloud Shell, cree una [aplicación web](overview.md) de varios contenedores en el plan de App Service `myAppServicePlan` con el comando [az webapp create](/cli/azure/webapp?view=azure-cli-latest#az-webapp-create). No olvide reemplazar _\<app-name>_ por un nombre de aplicación único.
...
En Cloud Shell, vuelva a configurar la [aplicación web](overview.md) de varios contenedores con el comando [az webapp config container set](/cli/azure/webapp/config/container?view=azure-cli-latest#az-webapp-config-container-set). No olvide reemplazar _\<app-name>_ por el nombre de la aplicación web que creó anteriormente.
...
En Cloud Shell, vuelva a configurar la [aplicación web](overview.md) de varios contenedores con el comando [az webapp config container set](/cli/azure/webapp/config/container?view=azure-cli-latest#az-webapp-config-container-set). No olvide reemplazar _\<app-name>_ por un nombre de aplicación único.
