...
Si usa PowerShell en macOS, siga los pasos descritos en [Instalación de PowerShell en macOS](/powershell/scripting/install/installing-powershell-core-on-macos?view=powershell-6).