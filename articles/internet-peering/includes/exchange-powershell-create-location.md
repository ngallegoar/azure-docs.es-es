...
A continuación se incluye un ejemplo en el que se muestra cómo usar Seattle como ubicación de emparejamiento para crear un emparejamiento de Exchange:
