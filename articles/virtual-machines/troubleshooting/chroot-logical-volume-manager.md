...
![Captura de pantalla que muestra la salida del comando lsblk.](./media/chroot-logical-volume-manager/lsblk-output-mounted.png)
...
![Captura de pantalla que muestra los LV visibles como particiones montadas.](./media/chroot-logical-volume-manager/chroot-all-mounts.png)

Consulte el **kernel** instalado.

![Captura de pantalla que muestra cómo consultar el kernel instalado.](./media/chroot-logical-volume-manager/rpm-kernel.png)
