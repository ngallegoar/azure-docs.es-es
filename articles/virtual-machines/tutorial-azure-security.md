---
title: 'Tutorial: Uso de Azure Security Center para máquinas virtuales en Azure'
description: En este tutorial, aprenderá sobre las características de Azure Security Center para ayudar a proteger las máquinas virtuales en Azure.
author: cynthn
manager: gwallace
...
ms.locfileid: "94594829"
---
# <a name="tutorial-use-azure-security-center-to-monitor-virtual-machines"></a>Tutorial: Uso de Azure Security Center para supervisar las máquinas virtuales
