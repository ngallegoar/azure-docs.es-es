---
title: Uso de Azure Portal para habilitar claves administradas por el cliente con SSE - discos administrados
description: Use Azure Portal para habilitar el cifrado del lado servidor mediante claves administradas por el cliente en los discos administrados.
author: roygara
ms.date: 07/10/2020
ms.topic: how-to
ms.author: rogarana
...
ms.locfileid: "86235703"
---
# <a name="enable-customer-managed-keys-with-server-side-encryption---managed-disks---portal"></a>Habilitación de claves administradas por el cliente con el cifrado del lado servidor - discos administrados - portal
