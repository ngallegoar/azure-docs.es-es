...
También es posible ejecutar WebLogic Server en Azure Virtual Machines. Las soluciones para ello se describen en [este artículo de Microsoft](/azure/virtual-machines/workloads/oracle/oracle-weblogic).
