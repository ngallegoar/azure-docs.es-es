...
1.  Cambie al usuario *oracle* y, a continuación, inicie el cliente de escucha de Oracle:
    ...
    ```
2. Creación de un directorio de datos para los archivos de datos de Oracle
