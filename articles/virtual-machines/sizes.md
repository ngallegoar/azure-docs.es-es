...
> [!NOTE]
  > Para obtener más información sobre cómo Azure asigna nombres a sus máquinas virtuales, consulte: [Convenciones de nomenclatura de los tamaños de las máquinas virtuales de Azure](https://docs.microsoft.com/azure/virtual-machines/vm-naming-conventions).
