...
Este artículo se probó por última vez el 14/2/2019 mediante [Azure Cloud Shell](https://shell.azure.com/bash) y la versión 2.0.58 de la [CLI de Azure](/cli/azure/install-azure-cli).
