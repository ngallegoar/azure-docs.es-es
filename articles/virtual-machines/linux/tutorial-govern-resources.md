...
description: En este tutorial aprenderá a usar la CLI de Azure para administrar máquinas virtuales de Azure aplicando Azure RBAC, directivas, bloqueos y etiquetas.
