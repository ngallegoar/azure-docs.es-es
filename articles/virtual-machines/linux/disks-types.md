---
title: 'Selección de un tipo de disco para máquinas virtuales Linux de IaaS de Azure: discos administrados'
description: Obtenga información sobre los tipos de disco de Azure disponibles para las máquinas virtuales Linux, a saber, los discos ultra, SSD premium, SSD estándar y HDD estándar.
author: roygara
ms.author: rogarana
ms.date: 11/04/2019
ms.topic: conceptual
