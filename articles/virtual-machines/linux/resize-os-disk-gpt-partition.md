...
Una vez reiniciada la VM, siga los pasos que se describen a continuación:
   ...
   1. Use el siguiente comando para instalar el paquete **gptfdisk**, que es necesario para aumentar el tamaño del disco de SO:
   ...
   1. Ejecute el comando **#lsblk** para comprobar si ha aumentado la partición.

      El resultado siguiente muestra que se ha cambiado el tamaño de la partición **/dev/sda4** a 98,5 GB.
   ...
   1. Identifique el tipo de sistema de archivos del disco de SO mediante el comando siguiente:
