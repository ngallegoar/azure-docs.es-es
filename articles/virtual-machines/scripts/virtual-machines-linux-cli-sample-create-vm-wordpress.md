---
title: 'Ejemplo de script de la CLI de Azure: creación de una máquina virtual Linux con WordPress'
...
| [az vm extension set](/cli/azure/vm) | Agregue la extensión de scripts personalizados a la máquina virtual que invoca un script para instalar WordPress. |
