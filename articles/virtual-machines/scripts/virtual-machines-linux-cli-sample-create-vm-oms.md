---
title: 'Ejemplo de script de la CLI de Azure: creación de una máquina virtual Linux con Azure Monitor'
description: 'Ejemplo de script de la CLI de Azure: creación de una máquina virtual Linux con Azure Monitor'
...
ms.locfileid: "87503623"
---
# <a name="monitor-a-vm-with-azure-monitor"></a>Supervisión de una máquina virtual con Azure Monitor
...
| [azure vm extension set](/cli/azure/vm/extension) | Ejecuta una extensión de máquina virtual en una máquina virtual. En este caso, la extensión de agente de Azure Monitor se usa para instalar el agente de Log Analytics e inscribir la máquina virtual en un área de trabajo de Log Analytics. |
