...
**Sin cambios en los recursos de Azure** El acceso a los recursos de Azure que se establecieron mediante Azure RBAC (control de acceso basado en rol) no se ve afectado por la actualización.
