...
1. En la página **Runbooks** de [Azure Portal](https://portal.azure.com/), haga clic en el runbook **StopAzureV2Vm** que muestra la hoja de información general del runbook.
...
4. Establezca el **nombre** del webhook en **Opcional**. El valor de la propiedad **Habilitada** debe ser **Sí**. El valor de **Expires** (Expira) no tiene que cambiarse. Para más información sobre las propiedades del webhook, consulte [Propiedades de un webhook](../../automation/automation-webhooks.md#webhook-properties).
