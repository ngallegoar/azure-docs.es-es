...
description: Obtenga información sobre el proceso de registro necesario para crear una suscripción de evaluación a Cloudyn y suscríbase al portal de Cloudyn.
author: bandersmsft
ms.author: banders
ms.date: 03/12/2020
ms.topic: quickstart
...
> Para más información, consulte [cómo conectarse a Partner Center API](/partner-center/develop/set-up-api-access-in-partner-center).
>
