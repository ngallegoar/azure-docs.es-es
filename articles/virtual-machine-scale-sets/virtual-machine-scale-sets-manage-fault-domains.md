...
Puede establecer la propiedad `properties.platformFaultDomainCount` en 1, 2 o 3 (el valor predeterminado es 3 si no se especifica). Consulte la documentación de la API REST [aquí](https://docs.microsoft.com/rest/api/compute/virtualmachinescalesets/createorupdate).

## <a name="azure-cli"></a>Azure CLI
Puede establecer el parámetro `--platform-fault-domain-count` en 1, 2 o 3 (el valor predeterminado es 3 si no se especifica). Consulte la documentación de la CLI de Azure [aquí](https://docs.microsoft.com/cli/azure/vmss?view=azure-cli-latest#az-vmss-create).
