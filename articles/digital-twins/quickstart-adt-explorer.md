...
* Dirección URL de ADT, con el formato *https://<instance host name>*
...
En el cuadro del selector de archivos, vaya de nuevo a la carpeta *client/examples* y elija el archivo de hoja de cálculo _**buildingScenario.xlsx**_. Este archivo contiene una descripción del grafo de ejemplo. Presione OK (Aceptar).
