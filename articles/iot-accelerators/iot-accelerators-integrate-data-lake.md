...
1. En el Explorador de datos, explore en profundidad la carpeta **/streaming**. Verá las carpetas creadas con el formato AAAA/MM/DD/HH.
    ...
    ![Captura de pantalla que muestra la ruta de acceso a la carpeta /streaming/AAAA/MM/DD/HH.](./media/iot-accelerators-integrate-data-lake/data-lake-store-data-explorer.png)
