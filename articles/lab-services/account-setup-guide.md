...
Para crear una cuenta de laboratorio necesita obtener acceso a una suscripción de Azure configurada para su escuela. Recuerde que es posible que su escuela tenga una o más suscripciones. Las suscripciones se usan para administrar la facturación y la seguridad de todos los recursos y servicios de Azure, incluidas las cuentas de laboratorio.  Normalmente, el departamento de TI se encarga de administrar las suscripciones de Azure.  Para obtener más información, consulte el siguiente tema:
 - [Guía del administrador: suscripción](https://docs.microsoft.com/azure/lab-services/classroom-labs/administrator-guide#subscription)
...
- [Guía del administrador: laboratorio](https://docs.microsoft.com/azure/lab-services/administrator-guide#classroom-lab)
...
- [Guía del administrador: grupo de recursos](https://docs.microsoft.com/azure/lab-services/administrator-guide#resource-group)
- [Guía del administrador: cuenta de laboratorio](https://docs.microsoft.com/azure/lab-services/administrator-guide#lab-account) 
- [Administración de costos de Azure Lab Services](https://docs.microsoft.com/azure/lab-services/cost-management-guide)
...
### <a name="who-should-be-owners-and-contributors-of-the-lab-account"></a>¿Quiénes deben ser propietarios y colaboradores de la cuenta de laboratorio?
   ...
   -  [Guía del administrador: administración de identidad](https://docs.microsoft.com/azure/lab-services/administrator-guide#manage-identity).
...
- [Guía del administrador: Shared Image Gallery](https://docs.microsoft.com/azure/lab-services/administrator-guide#shared-image-gallery)
- [Guía del administrador: precio de Shared Image Gallery](https://docs.microsoft.com/azure/lab-services/administrator-guide#shared-image-gallery-2)
...
- [Especificación de las imágenes de Marketplace disponibles para los creadores de laboratorios](https://docs.microsoft.com/azure/lab-services/specify-marketplace-images)
...
- [Aspectos básicos de la arquitectura: Virtual Network](https://docs.microsoft.com/azure/lab-services/classroom-labs-fundamentals#virtual-network)
- [Cómo conectarse a una red virtual](https://docs.microsoft.com/azure/lab-services/how-to-connect-peer-virtual-network)
- [Creación de un laboratorio con un recurso compartido en Azure Lab Services](https://docs.microsoft.com/azure/lab-services/how-to-create-a-lab-with-shared-resource)

## <a name="set-up-your-lab-account"></a>Configuración de la cuenta de laboratorio

Una vez finalizada la planeación, ya está listo para configurar la cuenta de laboratorio.  Estos mismos pasos son aplicables a la configuración de un laboratorio de [Azure Lab Services con Teams](https://docs.microsoft.com/azure/lab-services/lab-services-within-teams-overview).
