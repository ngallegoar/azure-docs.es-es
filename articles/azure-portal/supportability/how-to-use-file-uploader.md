...
* Todos los archivos deben tener una extensión de nombre de archivo, por ejemplo, *.docx* o *.xlsx*. Consulte en la tabla las extensiones de nombre de archivo permitidas.
