...
> [Creación de aplicaciones lógicas con o sin estado en Visual Studio Code (versión preliminar)](../logic-apps/create-stateful-stateless-workflows-visual-studio-code.md)
