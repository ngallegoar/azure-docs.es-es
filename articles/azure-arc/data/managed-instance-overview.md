...
SQL Managed Instance habilitada para Azure Arc esté actualmente en versión preliminar.
...
[Comenzar con la creación de un controlador de datos](create-data-controller.md)

¿Ha creado ya un controlador de datos? [Cree una instancia de SQL Managed Instance habilitada para Azure Arc](create-sql-managed-instance.md)
