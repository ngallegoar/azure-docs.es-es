...
|**Documentación de la API**|[Documentación de referencia de API de .NET](/dotnet/api/microsoft.azure.cosmosdb.bulkexecutor?preserve-view=true&view=azure-dotnet)|
