...
* Obtenga información sobre cómo [trabajar con la base de datos, los contenedores y los elementos de Azure Cosmos](account-databases-containers-items.md)
