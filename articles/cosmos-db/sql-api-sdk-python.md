...
> * [SDK de Java sincrónico v2](sql-api-sdk-java.md)
...
* La jerarquía de errores ahora se hereda de `azure.core.AzureError` en lugar de, que se ha quitado.
