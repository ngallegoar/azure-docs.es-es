...
:::image type="content" source="./media/use-cases/apps-with-global-reach.png" alt-text="Arquitectura de referencia de aplicaciones web de Azure Cosmos DB" border="false":::
