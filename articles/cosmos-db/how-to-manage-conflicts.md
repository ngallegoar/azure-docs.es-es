...
### <a name="java-sdk"></a><a id="create-custom-conflict-resolution-policy-lww-java">SDK de Java</a>

# <a name="java-async-sdk"></a>[SDK asincrónico para Java](#tab/async)
...
# <a name="java-sync-sdk"></a>[SDK sincrónico para Java](#tab/sync)
...
### <a name="java-sdk"></a><a id="create-custom-conflict-resolution-policy-stored-proc-java"></a>SDK de Java
...
### <a name="java-sdk"></a><a id="create-custom-conflict-resolution-policy-java"></a>SDK de Java
...
### <a name="java-sdk"></a><a id="read-from-conflict-feed-java"></a>SDK de Java
...
```
# <a name="java-async-sdk"></a>[SDK asincrónico para Java](#tab/sync)
