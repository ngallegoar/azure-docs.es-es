...
description: 'Tutorial: Obtenga información sobre cómo configurar la distribución global de Azure Cosmos DB mediante SQL API con .NET, Java, Python y otros SDK.'
author: markjbrown
ms.author: mjbrown
...
## <a name="java-v2-sdk"></a>SDK de Java V2
