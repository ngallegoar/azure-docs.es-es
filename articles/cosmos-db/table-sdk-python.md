...
|**Documentación de la API**|[Documentación de referencia de la API de Python](https://docs.microsoft.com/python/api/overview/azure/cosmosdb?view=azure-python)|
