...
- [Roles de Azure](../../../../role-based-access-control/overview.md) que se usan para la segregación de controles desde una perspectiva del plano de control. Antes de la implementación de cualquier infraestructura se definen tres roles:
  ...
  - El rol SecOps tiene los permisos necesarios para implementar y administrar [Azure Security Center](../../../../security-center/security-center-intro.md), establecer las definiciones de [Azure Policy](../../../policy/overview.md) y otros permisos relacionados con la seguridad
