...
ms.locfileid: "75470740"
---
# <a name="deploy-the-hipaa-hitrust-blueprint-sample"></a>Implementación del ejemplo de plano técnico de HIPAA HITRUST

Para implementar el ejemplo de plano técnico de HIPAA HITRUST, tiene que realizar los pasos siguientes:
...
|\[Versión preliminar\]: Auditar los controles HITRUST HIPAA e implementar extensiones de máquina virtual específicas para admitir los requisitos de auditoría |Asignación de directiva |Grupo de administradores |Grupo. Ejemplo: `Administrator; myUser1; myUser2` |
...
Ahora que ha revisado los pasos para implementar el ejemplo HITRUST HIPAA, consulte los siguientes artículos para obtener información general y sobre la asignación de controles:

> [!div class="nextstepaction"]
> [Planos técnicos de HITRUST HIPAA: Introducción](./index.md)
> [Planos técnicos de HITRUST HIPAA: Asignación de controles](./control-mapping.md)
