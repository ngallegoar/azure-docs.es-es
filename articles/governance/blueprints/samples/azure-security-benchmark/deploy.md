---
title: Ejemplo de implementación de plano técnico de Azure Security Benchmark
description: Pasos de implementación para el ejemplo de plano técnico de Azure Security Benchmark, incluidos los detalles de los parámetros del artefacto de plano técnico.
ms.date: 05/01/2020
ms.topic: sample
...
ms.locfileid: "82702676"
---
# <a name="deploy-the-azure-security-benchmark-blueprint-sample"></a>Ejemplo de implementación de plano técnico de Azure Security Benchmark
...
1. Busque el ejemplo de plano técnico de **Azure Security Benchmark** en _Otras muestras_ y haga clic en el nombre para seleccionar este ejemplo.
...
|-|-|-|-|
|Auditar las recomendaciones de Azure Security Benchmark e implementar extensiones de VM compatibles específicas|Asignación de directiva|
Lista de usuarios excluidos del grupo de administradores de VM de Windows|Lista separada por punto y coma de los miembros que se deben excluir en el grupo Administradores local. Por ejemplo: Administrador; miUsuario1; miUsuario2|
...
Ahora que ha revisado los pasos para implementar el ejemplo de plano técnico de Azure Security Benchmark, consulte los siguientes artículos para obtener información sobre el plano técnico y sobre la asignación de controles:

> [!div class="nextstepaction"]
> [Plano técnico de Azure Security Benchmark: información general](./index.md)
> [Plano técnico de Azure Security Benchmark: asignación de controles](./control-mapping.md)
