...
Ahora que ha revisado los pasos para implementar el ejemplo de plano técnico de CIS Microsoft Azure Foundations Benchmark, visite los siguientes artículos para obtener información sobre el plano técnico y sobre la asignación de controles:

> [!div class="nextstepaction"]
> [Plano técnico de CIS Microsoft Azure Foundations Benchmark: Introducción](./index.md)
> [Plano técnico de CIS Microsoft Azure Foundations Benchmark: asignación de controles](./control-mapping.md)
