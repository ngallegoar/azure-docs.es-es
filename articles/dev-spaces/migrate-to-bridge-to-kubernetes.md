...
1. Cree un registro de contenedor o use uno existente. Puede crear un registro de contenedor en Azure mediante [Azure Container Registry](../container-registry/index.yml) o [Docker Hub](https://hub.docker.com/).
