...
![Captura de pantalla de la interfaz de usuario de VS Code con la opción Asociado a un servidor (AZDS) seleccionada.](media/get-started-node/attach-nodejs.png)
