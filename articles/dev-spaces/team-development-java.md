...
ms.date: 08/01/2018
ms.topic: tutorial
description: En este tutorial se muestra cómo usar Azure Dev Spaces y Visual Studio Code para el desarrollo en equipo en una aplicación Java en Azure Kubernetes Service
...
* De todo ello se desprende que es difícil realizar cualquier prueba de integración. Las pruebas de integración solo pueden suceder de forma realista tras una confirmación, lo que significa que verá problemas más adelante en el ciclo de desarrollo.
    ...
    ![Diagrama que muestra los desafíos a los que se enfrenta al desarrollar microservicios.](media/common/microservices-challenges.png)
...
![Un diagrama que muestra una configuración de espacio C I C D simple.](media/common/ci-cd-space-setup.png)
