---
title: 'Inicio rápido: Interacción con un dispositivo IoT Plug and Play conectado a una solución de Azure IoT (Node.js) | Microsoft Docs'
description: 'Inicio rápido: Uso de Node.js para conectarse e interactuar con un dispositivo IoT Plug and Play conectado a una solución de Azure IoT'
author: elhorton
ms.author: elhorton
ms.date: 10/05/2020
ms.topic: quickstart
