---
title: Conexión del código del dispositivo Python de ejemplo de IoT Plug and Play a Azure IoT Hub | Microsoft Docs
description: Use Python para compilar y ejecutar el código de dispositivo de ejemplo de IoT Plug and Play que se conecta a un centro de IoT. Use la herramienta Azure IoT Explorer para ver la información enviada por el dispositivo al centro.
author: ericmitt
ms.author: ericmitt
ms.date: 7/14/2020
ms.topic: quickstart
