...
Si va a copiar el secreto de incorporación de cambios o hacerle referencia en otros scripts, debe tener el formato de una cadena JSON válida.
...
Ejecute el siguiente comando para crear un clúster. Opcionalmente, puede [pasar el secreto de incorporación de cambios de Red Hat](#get-a-red-hat-pull-secret-optional) que permite al clúster acceder a los registros de contenedor de Red Hat junto con contenido adicional.
