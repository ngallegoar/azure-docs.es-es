---
title: Administración del proceso del dispositivo Azure Stack Edge con GPU | Microsoft Docs
description: Descripción de cómo administrar la configuración del proceso en Edge, como el desencadenador o los módulos, y ver y quitar la configuración mediante Azure Portal en Azure Stack Edge con GPU.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "89268798"
---
# <a name="manage-compute-on-your-azure-stack-edge-gpu"></a>Administración del proceso en el dispositivo Azure Stack Edge con GPU
...
- Aprenda a [solucionar problemas en Azure Stack Edge](azure-stack-edge-gpu-troubleshoot.md).
