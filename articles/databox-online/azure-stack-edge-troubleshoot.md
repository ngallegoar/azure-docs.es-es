...
description: Describe cómo solucionar los problemas de Azure Stack Edge.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
2. Haga clic en la _carpeta de Microsoft Azure Stack Edge_. Esta carpeta tiene dos subcarpetas:
