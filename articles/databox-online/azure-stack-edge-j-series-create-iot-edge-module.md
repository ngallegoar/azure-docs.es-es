---
title: Módulo de IoT Edge en C# para Azure Stack Edge con GPU | Microsoft Docs
description: Aprenda a desarrollar un módulo de IoT Edge en C# que pueda implementarse en un dispositivo Azure Stack Edge con GPU.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
![Funcionamiento del módulo de Azure IoT Edge en Azure Stack Edge](./media/azure-stack-edge-j-series-create-iot-edge-module/how-module-works-1.png)
...
- Un dispositivo Azure Stack Edge que esté en ejecución.

    - El dispositivo también tiene un recurso de IoT Hub asociado.
    - El dispositivo tiene configurado el rol de proceso perimetral.
    Para más información, vaya a [Configurar proceso](azure-stack-edge-j-series-deploy-configure-compute.md#configure-compute) en Azure Stack Edge.
...
Para implementar y ejecutar este módulo en Azure Stack Edge, consulte los pasos que se indican en [Agregar un módulo](azure-stack-edge-j-series-deploy-configure-compute.md#add-a-module).
