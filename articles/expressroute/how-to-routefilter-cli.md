---
title: 'ExpressRoute: Filtros de ruta: emparejamiento de Microsoft: CLI de Azure'
...
Para poder asociar filtros de ruta con servicios de Microsoft 365 en ellos, debe tener autorización para consumir tales servicios mediante ExpressRoute. Si no la tiene, la operación para asociar filtros de ruta producirá un error. Para más información sobre el proceso de autorización, consulte [Azure ExpressRoute para Microsoft 365](/microsoft-365/enterprise/azure-expressroute).
