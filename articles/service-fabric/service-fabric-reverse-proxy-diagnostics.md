---
title: Diagnóstico de proxy inverso de Azure Service Fabric
description: Aprenda a supervisar y diagnosticar el procesamiento de solicitudes en el proxy inverso para una aplicación de Azure Service Fabric.
author: kavyako
ms.topic: conceptual
ms.date: 08/08/2017
ms.author: kavyako
...
1. El proxy inverso devuelve el código de estado de respuesta 504 (tiempo de espera agotado).
   ...
   El primer evento a continuación registra los detalles de la solicitud recibida en el proxy inverso. 
   El segundo evento indica que la solicitud no se pudo completar al reenviarse al servicio, debido al "error interno = ERROR_WINHTTP_TIMEOUT" 
