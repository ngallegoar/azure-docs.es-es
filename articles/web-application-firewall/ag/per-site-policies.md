...
* Aplicación de la directiva de WAF globalmente, por sitio y por URI (versión preliminar)
...
### <a name="apply-a-per-uri-policy-preview"></a>Aplicación de una directiva por URI (versión preliminar)
